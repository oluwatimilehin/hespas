module @test_dependency_graph attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<128x256xf32>, %arg1: tensor<256x512xf32>) -> tensor<128x512xf32> {
    ...
    // Operation c: all_reduce (depends on a) - COMMUNICATION OP
    %3 = "stablehlo.all_reduce"(%0) <{replica_groups = dense<0> : tensor<1x1xi64>}> ({
    ...
    %4 = stablehlo.tanh %3 : tensor<128x512xf32>
