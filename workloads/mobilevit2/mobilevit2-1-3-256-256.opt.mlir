module @jit_func attributes {mhlo.cross_program_prefetches = [], mhlo.input_output_alias = [], mhlo.is_dynamic = false, mhlo.use_auto_spmd_partitioning = false} {
  ...
  func.func private @fused_computation(%arg0: tensor<1x8x8x512xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x8x8x512xf32>, tensor<f32>) -> tensor<1x512xf32>
    return %0 : tensor<1x512xf32>
  }
  func.func private @fused_computation.1(%arg0: tensor<2xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512x2xf32>) -> tensor<2xf32> {
    %0 = stablehlo.dot %arg1, %arg2, precision = [DEFAULT, DEFAULT] : (tensor<512xf32>, tensor<512x2xf32>) -> tensor<2xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<2xf32>
    return %1 : tensor<2xf32>
  }
  func.func private @fused_computation.2(%arg0: tensor<2x512xf32>) -> tensor<512x2xf32> {
    %0 = stablehlo.transpose %arg0, dims = [1, 0] {result_layout = dense<[0, 1]> : tensor<2xindex>, xla_shape = "f32[512,2]{0,1}"} : (tensor<2x512xf32>) -> tensor<512x2xf32>
    %1 = mhlo.copy %0 : tensor<512x2xf32>
    return %1 : tensor<512x2xf32>
  }
  func.func private @fused_computation.3(%arg0: tensor<1x512xf32>) -> tensor<512xf32> {
    %cst = stablehlo.constant dense<1.562500e-02> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x512xf32>
    %1 = stablehlo.multiply %arg0, %0 : tensor<1x512xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[1, 0]> : tensor<2xindex>} : (tensor<1x512xf32>) -> tensor<512xf32>
    return %2 : tensor<512xf32>
  }
  func.func private @fused_computation.4(%arg0: tensor<512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<1x8x8x512xf32>, %arg4: tensor<512xf32>) -> tensor<1x8x8x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x8x8x512xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x8x8x512xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x8x8x512xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x8x8x512xf32>
    return %7 : tensor<1x8x8x512xf32>
  }
  func.func private @fused_computation.5(%arg0: tensor<512xf32>) -> tensor<512xf32> {
  ...
  func.func private @fused_computation.6(%arg0: tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32> {
  ...
  func.func private @fused_computation.7(%arg0: tensor<1x256x8x8xf32>) -> tensor<1x8x8x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,8,8,256]{2,1,3,0}"} : (tensor<1x256x8x8xf32>) -> tensor<1x8x8x256xf32>
    %1 = mhlo.copy %0 : tensor<1x8x8x256xf32>
    return %1 : tensor<1x8x8x256xf32>
  }
  func.func private @fused_computation.8(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<1x4x16x256xf32>, %arg5: tensor<256xf32>, %arg6: tensor<256xf32>) -> tensor<64x1x256x1x1xf32> {
    %0 = stablehlo.broadcast_in_dim %arg6, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = stablehlo.broadcast_in_dim %arg5, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %2 = stablehlo.add %arg4, %1 : tensor<1x4x16x256xf32>
    %3 = stablehlo.transpose %2, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %4 = mhlo.copy %3 : tensor<1x256x4x16xf32>
    %5 = stablehlo.add %4, %arg3 : tensor<1x256x4x16xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %7 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %8 = mhlo.bitcast %7 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %9 = stablehlo.broadcast_in_dim %8, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %10 = stablehlo.subtract %6, %9 : tensor<1x1x16384xf32>
    %11 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %12 = stablehlo.broadcast_in_dim %11, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %13 = stablehlo.multiply %10, %12 : tensor<1x1x16384xf32>
    %14 = mhlo.bitcast %13 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x256x4x16xf32>
    %15 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %16 = stablehlo.multiply %14, %15 : tensor<1x256x4x16xf32>
    %17 = stablehlo.add %0, %16 : tensor<1x256x4x16xf32>
    %18 = mhlo.bitcast %17 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x256x2x2x4x4xf32>
    %19 = stablehlo.transpose %18, dims = [2, 4, 3, 5, 0, 1] {result_layout = dense<[3, 1, 2, 0, 5, 4]> : tensor<6xindex>, xla_shape = "f32[2,4,2,4,1,256]{3,1,2,0,5,4}"} : (tensor<1x256x2x2x4x4xf32>) -> tensor<2x4x2x4x1x256xf32>
    %20 = mhlo.copy %19 : tensor<2x4x2x4x1x256xf32>
    %21 = mhlo.bitcast %20 {result_layout = dense<[2, 0, 4, 3, 1]> : tensor<5xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, xla_shape = "f32[64,1,256,1,1]{2,0,4,3,1}"} : (tensor<2x4x2x4x1x256xf32>) -> tensor<64x1x256x1x1xf32>
    %22 = mhlo.copy %21 : tensor<64x1x256x1x1xf32>
    return %22 : tensor<64x1x256x1x1xf32>
  }
  func.func private @region_69.88.clone.5.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.9(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
    %cst_1 = stablehlo.constant dense<9.99999974E-6> : tensor<1xf32>
    %2 = stablehlo.add %1, %cst_1 : tensor<1xf32>
    %3 = stablehlo.rsqrt %2 : tensor<1xf32>
    return %3 : tensor<1xf32>
  }
  func.func private @fused_computation.10(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>, %arg2: tensor<1x4x16x256xf32>, %arg3: tensor<256xf32>) -> tensor<1x16384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg3, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg2, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
    %4 = stablehlo.add %3, %arg1 : tensor<1x256x4x16xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %6 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %9 = stablehlo.subtract %5, %8 : tensor<1x1x16384xf32>
    %10 = stablehlo.multiply %9, %9 : tensor<1x1x16384xf32>
    %11 = mhlo.bitcast %10 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x16384xf32>
    return %11 : tensor<1x16384xf32>
  }
  func.func private @fused_computation.11(%arg0: tensor<1x256x4x16xf32>, %arg1: tensor<1x4x16x256xf32>, %arg2: tensor<256xf32>) -> tensor<1x1x16384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
    %4 = stablehlo.add %3, %arg0 : tensor<1x256x4x16xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    return %5 : tensor<1x1x16384xf32>
  }
  func.func private @fused_computation.12(%arg0: tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32> {
  ...
  func.func private @fused_computation.13(%arg0: tensor<1x4x16x512xf32>, %arg1: tensor<512xf32>) -> tensor<1x4x16x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x4x16x512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x512xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,4,16]{1,3,2,0}"} : (tensor<1x4x16x512xf32>) -> tensor<1x512x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x512x4x16xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %4 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x512x4x16xf32>
    %5 = stablehlo.negate %3 : tensor<1x512x4x16xf32>
    %6 = stablehlo.exponential %5 : tensor<1x512x4x16xf32>
    %7 = stablehlo.add %4, %6 : tensor<1x512x4x16xf32>
    %8 = stablehlo.divide %4, %7 : tensor<1x512x4x16xf32>
    %9 = stablehlo.multiply %3, %8 : tensor<1x512x4x16xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,16,512]{2,1,3,0}"} : (tensor<1x512x4x16xf32>) -> tensor<1x4x16x512xf32>
    %11 = mhlo.copy %10 : tensor<1x4x16x512xf32>
    return %11 : tensor<1x4x16x512xf32>
  }
  func.func private @fused_computation.14(%arg0: tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x512xf32>
    return %1 : tensor<1x1x256x512xf32>
  }
  func.func private @fused_computation.15(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %4 = stablehlo.broadcast_in_dim %3, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %5 = stablehlo.subtract %1, %4 : tensor<1x1x16384xf32>
    %6 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %8 = stablehlo.multiply %5, %7 : tensor<1x1x16384xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x256x4x16xf32>
    %10 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %11 = stablehlo.multiply %9, %10 : tensor<1x256x4x16xf32>
    %12 = stablehlo.add %0, %11 : tensor<1x256x4x16xf32>
    %13 = stablehlo.transpose %12, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,16,256]{2,1,3,0}"} : (tensor<1x256x4x16xf32>) -> tensor<1x4x16x256xf32>
    %14 = mhlo.copy %13 : tensor<1x4x16x256xf32>
    return %14 : tensor<1x4x16x256xf32>
  }
  func.func private @region_69.88.clone.4.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.16(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.17(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %4 = stablehlo.subtract %0, %3 : tensor<1x1x16384xf32>
    %5 = stablehlo.multiply %4, %4 : tensor<1x1x16384xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x16384xf32>
    return %6 : tensor<1x16384xf32>
  }
  func.func private @fused_computation.18(%arg0: tensor<1x256x4x16xf32>, %arg1: tensor<1x4x16x256xf32>, %arg2: tensor<256xf32>) -> tensor<1x256x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
  ...
  func.func private @fused_computation.19(%arg0: tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32> {
  ...
  func.func private @fused_computation.20(%arg0: tensor<1x256x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
    %4 = stablehlo.slice %3 [0:1, 257:513, 0:4, 0:16] : (tensor<1x513x4x16xf32>) -> tensor<1x256x4x16xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x256x4x16xf32>
    %6 = stablehlo.maximum %4, %5 : tensor<1x256x4x16xf32>
    %7 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x256x4xf32>) -> tensor<256x4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [1, 2] : (tensor<256x4xf32>) -> tensor<1x256x4x16xf32>
    %9 = stablehlo.multiply %6, %8 : tensor<1x256x4x16xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,16,256]{2,1,3,0}"} : (tensor<1x256x4x16xf32>) -> tensor<1x4x16x256xf32>
    %11 = mhlo.copy %10 : tensor<1x4x16x256xf32>
    return %11 : tensor<1x4x16x256xf32>
  }
  func.func private @region_91.118(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.21(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x256x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
    %4 = stablehlo.slice %3 [0:1, 1:257, 0:4, 0:16] : (tensor<1x513x4x16xf32>) -> tensor<1x256x4x16xf32>
    %5 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x1x4x16xf32>) -> tensor<4x16xf32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [2, 3] : (tensor<4x16xf32>) -> tensor<1x256x4x16xf32>
    %7 = stablehlo.multiply %4, %6 : tensor<1x256x4x16xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %8 = stablehlo.reduce(%7 init: %cst) applies stablehlo.add across dimensions = [3] : (tensor<1x256x4x16xf32>, tensor<f32>) -> tensor<1x256x4xf32>
    return %8 : tensor<1x256x4xf32>
  }
  func.func private @fused_computation.22(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x16xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x16xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x16xf32>
    return %2 : tensor<1x1x4x16xf32>
  }
  func.func private @fused_computation.23(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x1x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:16] : (tensor<1x513x4x16xf32>) -> tensor<1x1x4x16xf32>
    %cst = stablehlo.constant dense<0xFF800000> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x1x4xf32>
    %6 = stablehlo.maximum %5, %arg0 : tensor<1x1x4xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x16xf32>
    %9 = stablehlo.subtract %4, %8 : tensor<1x1x4x16xf32>
    %10 = stablehlo.exponential %9 : tensor<1x1x4x16xf32>
    return %10 : tensor<1x1x4x16xf32>
  }
  func.func private @region_89.116(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.maximum %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.24(%arg0: tensor<1x4x16x513xf32>, %arg1: tensor<513xf32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:16] : (tensor<1x513x4x16xf32>) -> tensor<1x1x4x16xf32>
    %cst = stablehlo.constant dense<0xFF800000> : tensor<f32>
    %5 = stablehlo.reduce(%4 init: %cst) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x16xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %5 : tensor<1x1x4xf32>
  }
  func.func private @fused_computation.25(%arg0: tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32> {
  ...
  func.func private @fused_computation.26(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.27(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.28(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.29(%arg0: tensor<1x256x4x16xf32>, %arg1: tensor<1x4x16x256xf32>, %arg2: tensor<256xf32>) -> tensor<1x256x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
  ...
  func.func private @fused_computation.30(%arg0: tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,512,256]{1,0,2,3}"} : (tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x512x256xf32>
    return %1 : tensor<1x1x512x256xf32>
  }
  func.func private @fused_computation.31(%arg0: tensor<1x4x16x512xf32>, %arg1: tensor<512xf32>) -> tensor<1x4x16x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x4x16x512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x512xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,4,16]{1,3,2,0}"} : (tensor<1x4x16x512xf32>) -> tensor<1x512x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x512x4x16xf32>
  ...
  func.func private @fused_computation.32(%arg0: tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x512xf32>
    return %1 : tensor<1x1x256x512xf32>
  }
  func.func private @fused_computation.33(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.34(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.35(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.36(%arg0: tensor<1x256x4x16xf32>, %arg1: tensor<1x4x16x256xf32>, %arg2: tensor<256xf32>) -> tensor<1x256x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
  ...
  func.func private @fused_computation.37(%arg0: tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x256xf32>
    return %1 : tensor<1x1x256x256xf32>
  }
  func.func private @fused_computation.38(%arg0: tensor<1x256x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.39(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x256x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.40(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x16xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x16xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x16xf32>
    return %2 : tensor<1x1x4x16xf32>
  }
  func.func private @fused_computation.41(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x1x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.42(%arg0: tensor<1x4x16x513xf32>, %arg1: tensor<513xf32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.43(%arg0: tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,513]{1,0,2,3}"} : (tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x513xf32>
    return %1 : tensor<1x1x256x513xf32>
  }
  func.func private @fused_computation.44(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.45(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.46(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.47(%arg0: tensor<1x256x4x16xf32>, %arg1: tensor<1x4x16x256xf32>, %arg2: tensor<256xf32>) -> tensor<1x256x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
  ...
  func.func private @fused_computation.48(%arg0: tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,512,256]{1,0,2,3}"} : (tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x512x256xf32>
    return %1 : tensor<1x1x512x256xf32>
  }
  func.func private @fused_computation.49(%arg0: tensor<1x4x16x512xf32>, %arg1: tensor<512xf32>) -> tensor<1x4x16x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x4x16x512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x512xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,4,16]{1,3,2,0}"} : (tensor<1x4x16x512xf32>) -> tensor<1x512x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x512x4x16xf32>
  ...
  func.func private @fused_computation.50(%arg0: tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x512xf32>
    return %1 : tensor<1x1x256x512xf32>
  }
  func.func private @fused_computation.51(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x256x4x16xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.52(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.53(%arg0: tensor<1xf32>, %arg1: tensor<1x256x4x16xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.54(%arg0: tensor<1x4x16x256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<64x1x256x1x1xf32>) -> tensor<1x256x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x16xf32>
    %4 = mhlo.bitcast %arg2 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<64x1x256x1x1xf32>) -> tensor<2x4x2x4x1x256xf32>
    %5 = stablehlo.transpose %4, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,256,2,2,4,4]{1,0,5,3,4,2}"} : (tensor<2x4x2x4x1x256xf32>) -> tensor<1x256x2x2x4x4xf32>
    %6 = mhlo.copy %5 : tensor<1x256x2x2x4x4xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x256x2x2x4x4xf32>) -> tensor<1x256x4x16xf32>
    %8 = stablehlo.add %3, %7 : tensor<1x256x4x16xf32>
    return %8 : tensor<1x256x4x16xf32>
  }
  func.func private @fused_computation.55(%arg0: tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x256xf32>
    return %1 : tensor<1x1x256x256xf32>
  }
  func.func private @fused_computation.56(%arg0: tensor<1x256x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.57(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x256x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.58(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x16xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x16xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x16xf32>
    return %2 : tensor<1x1x4x16xf32>
  }
  func.func private @fused_computation.59(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x16x513xf32>, %arg2: tensor<513xf32>) -> tensor<1x1x4x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.60(%arg0: tensor<1x4x16x513xf32>, %arg1: tensor<513xf32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x16x513xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    %3 = mhlo.copy %2 : tensor<1x513x4x16xf32>
  ...
  func.func private @fused_computation.61(%arg0: tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,513]{1,0,2,3}"} : (tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x513xf32>
    return %1 : tensor<1x1x256x513xf32>
  }
  func.func private @fused_computation.62(%arg0: tensor<256xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<64x1x256x1x1xf32>, %arg4: tensor<256xf32>) -> tensor<1x4x16x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<64x1x256x1x1xf32>) -> tensor<2x4x2x4x1x256xf32>
    %2 = stablehlo.transpose %1, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,256,2,2,4,4]{1,0,5,3,4,2}"} : (tensor<2x4x2x4x1x256xf32>) -> tensor<1x256x2x2x4x4xf32>
    %3 = mhlo.copy %2 : tensor<1x256x2x2x4x4xf32>
    %4 = mhlo.bitcast %3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x256x2x2x4x4xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %5 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %8 = stablehlo.subtract %4, %7 : tensor<1x1x16384xf32>
    %9 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %10 = stablehlo.broadcast_in_dim %9, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %11 = stablehlo.multiply %8, %10 : tensor<1x1x16384xf32>
    %12 = mhlo.bitcast %11 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x256x4x16xf32>
    %13 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
    %14 = stablehlo.multiply %12, %13 : tensor<1x256x4x16xf32>
    %15 = stablehlo.add %0, %14 : tensor<1x256x4x16xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,16,256]{2,1,3,0}"} : (tensor<1x256x4x16xf32>) -> tensor<1x4x16x256xf32>
    %17 = mhlo.copy %16 : tensor<1x4x16x256xf32>
    return %17 : tensor<1x4x16x256xf32>
  }
  func.func private @region_69.88.clone.7(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.63(%arg0: tensor<1x16xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x16xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.64(%arg0: tensor<1xf32>, %arg1: tensor<64x1x256x1x1xf32>) -> tensor<1x16384xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<64x1x256x1x1xf32>) -> tensor<2x4x2x4x1x256xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,256,2,2,4,4]{1,0,5,3,4,2}"} : (tensor<2x4x2x4x1x256xf32>) -> tensor<1x256x2x2x4x4xf32>
    %2 = mhlo.copy %1 : tensor<1x256x2x2x4x4xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x256x2x2x4x4xf32>) -> tensor<1x1x16384xf32>
    %cst = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    %4 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [] : (tensor<f32>) -> tensor<1x1x16384xf32>
    %7 = stablehlo.subtract %3, %6 : tensor<1x1x16384xf32>
    %8 = stablehlo.multiply %7, %7 : tensor<1x1x16384xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x16384xf32>) -> tensor<1x16384xf32>
    return %9 : tensor<1x16384xf32>
  }
  func.func private @fused_computation.65(%arg0: tensor<64x1x256x1x1xf32>) -> tensor<1x1x16384xf32> {
    %0 = mhlo.bitcast %arg0 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<64x1x256x1x1xf32>) -> tensor<2x4x2x4x1x256xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,256,2,2,4,4]{1,0,5,3,4,2}"} : (tensor<2x4x2x4x1x256xf32>) -> tensor<1x256x2x2x4x4xf32>
    %2 = mhlo.copy %1 : tensor<1x256x2x2x4x4xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x256x2x2x4x4xf32>) -> tensor<1x1x16384xf32>
    return %3 : tensor<1x1x16384xf32>
  }
  func.func private @fused_computation.66(%arg0: tensor<1x8x8x256xf32>, %arg1: tensor<2x4x2x4x2xi32>) -> tensor<64x1x256x1x1xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,8,8]{1,3,2,0}"} : (tensor<1x8x8x256xf32>) -> tensor<1x256x8x8xf32>
    %1 = mhlo.copy %0 : tensor<1x256x8x8xf32>
    ...
    %3 = "stablehlo.gather"(%1, %2) <{dimension_numbers = #stablehlo.gather<offset_dims = [1, 2, 3, 4], start_index_map = [2, 3], index_vector_dim = 1>, indices_are_sorted = false, slice_sizes = array<i64: 1, 256, 1, 1>}> : (tensor<1x256x8x8xf32>, tensor<64x2xi32>) -> tensor<64x1x256x1x1xf32>
    return %3 : tensor<64x1x256x1x1xf32>
  }
  ...
  func.func private @fused_computation.68(%arg0: tensor<512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<1x8x8x512xf32>, %arg4: tensor<512xf32>) -> tensor<1x8x8x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x8x8x512xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x8x8x512xf32>
    ...
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x8x8x512xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,8,8]{1,3,2,0}"} : (tensor<1x8x8x512xf32>) -> tensor<1x512x8x8xf32>
    %9 = mhlo.copy %8 : tensor<1x512x8x8xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x512x8x8xf32>
    %11 = stablehlo.negate %9 : tensor<1x512x8x8xf32>
    %12 = stablehlo.exponential %11 : tensor<1x512x8x8xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x512x8x8xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x512x8x8xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x512x8x8xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,8,8,512]{2,1,3,0}"} : (tensor<1x512x8x8xf32>) -> tensor<1x8x8x512xf32>
    %17 = mhlo.copy %16 : tensor<1x8x8x512xf32>
    return %17 : tensor<1x8x8x512xf32>
  }
  func.func private @fused_computation.69(%arg0: tensor<512xf32>) -> tensor<512xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<512xf32>
    %2 = stablehlo.rsqrt %1 : tensor<512xf32>
  ...
  func.func private @fused_computation.70(%arg0: tensor<512x1x3x3xf32>) -> tensor<3x3x1x512xf32> {
  ...
  func.func private @fused_computation.71(%arg0: tensor<512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<1x8x8x512xf32>, %arg4: tensor<512xf32>) -> tensor<1x8x8x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x8x8x512xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x8x8x512xf32>
  ...
  func.func private @fused_computation.72(%arg0: tensor<512xf32>) -> tensor<512xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<512xf32>
    %2 = stablehlo.rsqrt %1 : tensor<512xf32>
  ...
  func.func private @fused_computation.73(%arg0: tensor<512x768x1x1xf32>) -> tensor<1x1x768x512xf32> {
  ...
  func.func private @fused_computation.74(%arg0: tensor<768xf32>, %arg1: tensor<768xf32>, %arg2: tensor<768xf32>, %arg3: tensor<1x8x8x768xf32>, %arg4: tensor<768xf32>) -> tensor<1x8x8x768xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<768xf32>) -> tensor<1x8x8x768xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x8x8x768xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<768xf32>) -> tensor<1x8x8x768xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x8x8x768xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<768xf32>) -> tensor<1x8x8x768xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x8x8x768xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<768xf32>) -> tensor<1x8x8x768xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x8x8x768xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,768,8,8]{1,3,2,0}"} : (tensor<1x8x8x768xf32>) -> tensor<1x768x8x8xf32>
    %9 = mhlo.copy %8 : tensor<1x768x8x8xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x768x8x8xf32>
    %11 = stablehlo.negate %9 : tensor<1x768x8x8xf32>
    %12 = stablehlo.exponential %11 : tensor<1x768x8x8xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x768x8x8xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x768x8x8xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x768x8x8xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,8,8,768]{2,1,3,0}"} : (tensor<1x768x8x8xf32>) -> tensor<1x8x8x768xf32>
    %17 = mhlo.copy %16 : tensor<1x8x8x768xf32>
    return %17 : tensor<1x8x8x768xf32>
  }
  func.func private @fused_computation.75(%arg0: tensor<768xf32>) -> tensor<768xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.76(%arg0: tensor<768x1x3x3xf32>) -> tensor<3x3x1x768xf32> {
  ...
  func.func private @fused_computation.77(%arg0: tensor<768xf32>, %arg1: tensor<768xf32>, %arg2: tensor<768xf32>, %arg3: tensor<1x16x16x768xf32>, %arg4: tensor<768xf32>) -> tensor<1x16x16x768xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<768xf32>) -> tensor<1x16x16x768xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x16x16x768xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<768xf32>) -> tensor<1x16x16x768xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x16x16x768xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<768xf32>) -> tensor<1x16x16x768xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x16x16x768xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<768xf32>) -> tensor<1x16x16x768xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x16x16x768xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,768,16,16]{1,3,2,0}"} : (tensor<1x16x16x768xf32>) -> tensor<1x768x16x16xf32>
    %9 = mhlo.copy %8 : tensor<1x768x16x16xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x768x16x16xf32>
    %11 = stablehlo.negate %9 : tensor<1x768x16x16xf32>
    %12 = stablehlo.exponential %11 : tensor<1x768x16x16xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x768x16x16xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x768x16x16xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x768x16x16xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,16,16,768]{2,1,3,0}"} : (tensor<1x768x16x16xf32>) -> tensor<1x16x16x768xf32>
    %17 = mhlo.copy %16 : tensor<1x16x16x768xf32>
    return %17 : tensor<1x16x16x768xf32>
  }
  func.func private @fused_computation.78(%arg0: tensor<768xf32>) -> tensor<768xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<768xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<768xf32>
    %2 = stablehlo.rsqrt %1 : tensor<768xf32>
  ...
  func.func private @fused_computation.79(%arg0: tensor<768x384x1x1xf32>) -> tensor<1x1x384x768xf32> {
  ...
  func.func private @fused_computation.80(%arg0: tensor<384xf32>, %arg1: tensor<384xf32>, %arg2: tensor<384xf32>, %arg3: tensor<1x16x16x384xf32>, %arg4: tensor<384xf32>) -> tensor<1x16x16x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x16x16x384xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x16x16x384xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x16x16x384xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x16x16x384xf32>
    return %7 : tensor<1x16x16x384xf32>
  }
  func.func private @fused_computation.81(%arg0: tensor<384xf32>) -> tensor<384xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.82(%arg0: tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32> {
  ...
  func.func private @fused_computation.83(%arg0: tensor<1x192x16x16xf32>) -> tensor<1x16x16x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,16,16,192]{2,1,3,0}"} : (tensor<1x192x16x16xf32>) -> tensor<1x16x16x192xf32>
    %1 = mhlo.copy %0 : tensor<1x16x16x192xf32>
    return %1 : tensor<1x16x16x192xf32>
  }
  func.func private @fused_computation.84(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<1x4x64x192xf32>, %arg5: tensor<192xf32>, %arg6: tensor<192xf32>) -> tensor<256x1x192x1x1xf32> {
    %0 = stablehlo.broadcast_in_dim %arg6, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = stablehlo.broadcast_in_dim %arg5, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %2 = stablehlo.add %arg4, %1 : tensor<1x4x64x192xf32>
    %3 = stablehlo.transpose %2, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %4 = mhlo.copy %3 : tensor<1x192x4x64xf32>
    %5 = stablehlo.add %4, %arg3 : tensor<1x192x4x64xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %7 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %8 = mhlo.bitcast %7 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %9 = stablehlo.broadcast_in_dim %8, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %10 = stablehlo.subtract %6, %9 : tensor<1x1x49152xf32>
    %11 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %12 = stablehlo.broadcast_in_dim %11, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %13 = stablehlo.multiply %10, %12 : tensor<1x1x49152xf32>
    %14 = mhlo.bitcast %13 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x192x4x64xf32>
    %15 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %16 = stablehlo.multiply %14, %15 : tensor<1x192x4x64xf32>
    %17 = stablehlo.add %0, %16 : tensor<1x192x4x64xf32>
    %18 = mhlo.bitcast %17 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x192x2x2x8x8xf32>
    %19 = stablehlo.transpose %18, dims = [2, 4, 3, 5, 0, 1] {result_layout = dense<[3, 1, 2, 0, 5, 4]> : tensor<6xindex>, xla_shape = "f32[2,8,2,8,1,192]{3,1,2,0,5,4}"} : (tensor<1x192x2x2x8x8xf32>) -> tensor<2x8x2x8x1x192xf32>
    %20 = mhlo.copy %19 : tensor<2x8x2x8x1x192xf32>
    %21 = mhlo.bitcast %20 {result_layout = dense<[2, 0, 4, 3, 1]> : tensor<5xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, xla_shape = "f32[256,1,192,1,1]{2,0,4,3,1}"} : (tensor<2x8x2x8x1x192xf32>) -> tensor<256x1x192x1x1xf32>
    %22 = mhlo.copy %21 : tensor<256x1x192x1x1xf32>
    return %22 : tensor<256x1x192x1x1xf32>
  }
  func.func private @region_27.35.clone.7.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.85(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
    %cst_1 = stablehlo.constant dense<9.99999974E-6> : tensor<1xf32>
    %2 = stablehlo.add %1, %cst_1 : tensor<1xf32>
    %3 = stablehlo.rsqrt %2 : tensor<1xf32>
  ...
  func.func private @fused_computation.86(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>, %arg2: tensor<1x4x64x192xf32>, %arg3: tensor<192xf32>) -> tensor<1x49152xf32> {
    %0 = stablehlo.broadcast_in_dim %arg3, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg2, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
    %4 = stablehlo.add %3, %arg1 : tensor<1x192x4x64xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %6 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %9 = stablehlo.subtract %5, %8 : tensor<1x1x49152xf32>
    %10 = stablehlo.multiply %9, %9 : tensor<1x1x49152xf32>
    %11 = mhlo.bitcast %10 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x49152xf32>
    return %11 : tensor<1x49152xf32>
  }
  func.func private @fused_computation.87(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x1x49152xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
    %4 = stablehlo.add %3, %arg0 : tensor<1x192x4x64xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    return %5 : tensor<1x1x49152xf32>
  }
  func.func private @fused_computation.88(%arg0: tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32> {
  ...
  func.func private @fused_computation.89(%arg0: tensor<1x4x64x384xf32>, %arg1: tensor<384xf32>) -> tensor<1x4x64x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x384xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x384x4x64xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %4 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x384x4x64xf32>
    %5 = stablehlo.negate %3 : tensor<1x384x4x64xf32>
    %6 = stablehlo.exponential %5 : tensor<1x384x4x64xf32>
    %7 = stablehlo.add %4, %6 : tensor<1x384x4x64xf32>
    %8 = stablehlo.divide %4, %7 : tensor<1x384x4x64xf32>
    %9 = stablehlo.multiply %3, %8 : tensor<1x384x4x64xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,64,384]{2,1,3,0}"} : (tensor<1x384x4x64xf32>) -> tensor<1x4x64x384xf32>
    %11 = mhlo.copy %10 : tensor<1x4x64x384xf32>
    return %11 : tensor<1x4x64x384xf32>
  }
  func.func private @fused_computation.90(%arg0: tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x384xf32>
    return %1 : tensor<1x1x192x384xf32>
  }
  func.func private @fused_computation.91(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %4 = stablehlo.broadcast_in_dim %3, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %5 = stablehlo.subtract %1, %4 : tensor<1x1x49152xf32>
    %6 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %8 = stablehlo.multiply %5, %7 : tensor<1x1x49152xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x192x4x64xf32>
    %10 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %11 = stablehlo.multiply %9, %10 : tensor<1x192x4x64xf32>
    %12 = stablehlo.add %0, %11 : tensor<1x192x4x64xf32>
    %13 = stablehlo.transpose %12, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,64,192]{2,1,3,0}"} : (tensor<1x192x4x64xf32>) -> tensor<1x4x64x192xf32>
    %14 = mhlo.copy %13 : tensor<1x4x64x192xf32>
    return %14 : tensor<1x4x64x192xf32>
  }
  func.func private @region_27.35.clone.6.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.92(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.93(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %4 = stablehlo.subtract %0, %3 : tensor<1x1x49152xf32>
    %5 = stablehlo.multiply %4, %4 : tensor<1x1x49152xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x49152xf32>
    return %6 : tensor<1x49152xf32>
  }
  func.func private @fused_computation.94(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
    %4 = stablehlo.add %3, %arg0 : tensor<1x192x4x64xf32>
    return %4 : tensor<1x192x4x64xf32>
  }
  func.func private @fused_computation.95(%arg0: tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32> {
  ...
  func.func private @fused_computation.96(%arg0: tensor<1x192x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
    %4 = stablehlo.slice %3 [0:1, 193:385, 0:4, 0:64] : (tensor<1x385x4x64xf32>) -> tensor<1x192x4x64xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x192x4x64xf32>
    %6 = stablehlo.maximum %4, %5 : tensor<1x192x4x64xf32>
    %7 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x192x4xf32>) -> tensor<192x4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [1, 2] : (tensor<192x4xf32>) -> tensor<1x192x4x64xf32>
    %9 = stablehlo.multiply %6, %8 : tensor<1x192x4x64xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,64,192]{2,1,3,0}"} : (tensor<1x192x4x64xf32>) -> tensor<1x4x64x192xf32>
    %11 = mhlo.copy %10 : tensor<1x4x64x192xf32>
    return %11 : tensor<1x4x64x192xf32>
  }
  func.func private @fused_computation.97(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
    %4 = stablehlo.slice %3 [0:1, 1:193, 0:4, 0:64] : (tensor<1x385x4x64xf32>) -> tensor<1x192x4x64xf32>
    %5 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x1x4x64xf32>) -> tensor<4x64xf32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [2, 3] : (tensor<4x64xf32>) -> tensor<1x192x4x64xf32>
    %7 = stablehlo.multiply %4, %6 : tensor<1x192x4x64xf32>
    return %7 : tensor<1x192x4x64xf32>
  }
  func.func private @fused_computation.98(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x64xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x64xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x64xf32>
    return %2 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.99(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:64] : (tensor<1x385x4x64xf32>) -> tensor<1x1x4x64xf32>
    %cst = stablehlo.constant dense<0xFF800000> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x1x4xf32>
    %6 = stablehlo.maximum %5, %arg0 : tensor<1x1x4xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x64xf32>
    %9 = stablehlo.subtract %4, %8 : tensor<1x1x4x64xf32>
    %10 = stablehlo.exponential %9 : tensor<1x1x4x64xf32>
    return %10 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.100(%arg0: tensor<1x4x64x385xf32>, %arg1: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:64] : (tensor<1x385x4x64xf32>) -> tensor<1x1x4x64xf32>
    return %4 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.101(%arg0: tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32> {
  ...
  func.func private @fused_computation.102(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.103(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.104(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.105(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
  ...
  func.func private @fused_computation.106(%arg0: tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x384x192xf32>
    return %1 : tensor<1x1x384x192xf32>
  }
  func.func private @fused_computation.107(%arg0: tensor<1x4x64x384xf32>, %arg1: tensor<384xf32>) -> tensor<1x4x64x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x384xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x384x4x64xf32>
  ...
  func.func private @fused_computation.108(%arg0: tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x384xf32>
    return %1 : tensor<1x1x192x384xf32>
  }
  func.func private @fused_computation.109(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.110(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.111(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.112(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
  ...
  func.func private @fused_computation.113(%arg0: tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x192xf32>
    return %1 : tensor<1x1x192x192xf32>
  }
  func.func private @fused_computation.114(%arg0: tensor<1x192x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.115(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.116(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x64xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x64xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x64xf32>
    return %2 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.117(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.118(%arg0: tensor<1x4x64x385xf32>, %arg1: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.119(%arg0: tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x385xf32>
    return %1 : tensor<1x1x192x385xf32>
  }
  func.func private @fused_computation.120(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.121(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.122(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.123(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
  ...
  func.func private @fused_computation.124(%arg0: tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x384x192xf32>
    return %1 : tensor<1x1x384x192xf32>
  }
  func.func private @fused_computation.125(%arg0: tensor<1x4x64x384xf32>, %arg1: tensor<384xf32>) -> tensor<1x4x64x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x384xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x384x4x64xf32>
  ...
  func.func private @fused_computation.126(%arg0: tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x384xf32>
    return %1 : tensor<1x1x192x384xf32>
  }
  func.func private @fused_computation.127(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.128(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.129(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.130(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
  ...
  func.func private @fused_computation.131(%arg0: tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x192xf32>
    return %1 : tensor<1x1x192x192xf32>
  }
  func.func private @fused_computation.132(%arg0: tensor<1x192x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.133(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.134(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x64xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x64xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x64xf32>
    return %2 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.135(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.136(%arg0: tensor<1x4x64x385xf32>, %arg1: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.137(%arg0: tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x385xf32>
    return %1 : tensor<1x1x192x385xf32>
  }
  func.func private @fused_computation.138(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.139(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.140(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.141(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<1x4x64x192xf32>, %arg2: tensor<192xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
  ...
  func.func private @fused_computation.142(%arg0: tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x384x192xf32>
    return %1 : tensor<1x1x384x192xf32>
  }
  func.func private @fused_computation.143(%arg0: tensor<1x4x64x384xf32>, %arg1: tensor<384xf32>) -> tensor<1x4x64x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x384xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x384x4x64xf32>
  ...
  func.func private @fused_computation.144(%arg0: tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x384xf32>
    return %1 : tensor<1x1x192x384xf32>
  }
  func.func private @fused_computation.145(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x192x4x64xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @fused_computation.146(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.147(%arg0: tensor<1xf32>, %arg1: tensor<1x192x4x64xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.148(%arg0: tensor<1x4x64x192xf32>, %arg1: tensor<192xf32>, %arg2: tensor<256x1x192x1x1xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x192xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x192x4x64xf32>
    %4 = mhlo.bitcast %arg2 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<256x1x192x1x1xf32>) -> tensor<2x8x2x8x1x192xf32>
    %5 = stablehlo.transpose %4, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,192,2,2,8,8]{1,0,5,3,4,2}"} : (tensor<2x8x2x8x1x192xf32>) -> tensor<1x192x2x2x8x8xf32>
    %6 = mhlo.copy %5 : tensor<1x192x2x2x8x8xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x192x2x2x8x8xf32>) -> tensor<1x192x4x64xf32>
    %8 = stablehlo.add %3, %7 : tensor<1x192x4x64xf32>
    return %8 : tensor<1x192x4x64xf32>
  }
  func.func private @fused_computation.149(%arg0: tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x192xf32>
    return %1 : tensor<1x1x192x192xf32>
  }
  func.func private @fused_computation.150(%arg0: tensor<1x192x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.151(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x192x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.152(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x64xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x64xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x64xf32>
    return %2 : tensor<1x1x4x64xf32>
  }
  func.func private @fused_computation.153(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x64x385xf32>, %arg2: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.154(%arg0: tensor<1x4x64x385xf32>, %arg1: tensor<385xf32>) -> tensor<1x1x4x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x64x385xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    %3 = mhlo.copy %2 : tensor<1x385x4x64xf32>
  ...
  func.func private @fused_computation.155(%arg0: tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
    %1 = mhlo.copy %0 : tensor<1x1x192x385xf32>
    return %1 : tensor<1x1x192x385xf32>
  }
  func.func private @fused_computation.156(%arg0: tensor<192xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<256x1x192x1x1xf32>, %arg4: tensor<192xf32>) -> tensor<1x4x64x192xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<256x1x192x1x1xf32>) -> tensor<2x8x2x8x1x192xf32>
    %2 = stablehlo.transpose %1, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,192,2,2,8,8]{1,0,5,3,4,2}"} : (tensor<2x8x2x8x1x192xf32>) -> tensor<1x192x2x2x8x8xf32>
    %3 = mhlo.copy %2 : tensor<1x192x2x2x8x8xf32>
    %4 = mhlo.bitcast %3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x192x2x2x8x8xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %5 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %8 = stablehlo.subtract %4, %7 : tensor<1x1x49152xf32>
    %9 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %10 = stablehlo.broadcast_in_dim %9, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %11 = stablehlo.multiply %8, %10 : tensor<1x1x49152xf32>
    %12 = mhlo.bitcast %11 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x192x4x64xf32>
    ...
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,64,192]{2,1,3,0}"} : (tensor<1x192x4x64xf32>) -> tensor<1x4x64x192xf32>
    %17 = mhlo.copy %16 : tensor<1x4x64x192xf32>
    return %17 : tensor<1x4x64x192xf32>
  }
  func.func private @region_27.35.clone.10(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.157(%arg0: tensor<1x2xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x2xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.158(%arg0: tensor<1xf32>, %arg1: tensor<256x1x192x1x1xf32>) -> tensor<1x49152xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<256x1x192x1x1xf32>) -> tensor<2x8x2x8x1x192xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,192,2,2,8,8]{1,0,5,3,4,2}"} : (tensor<2x8x2x8x1x192xf32>) -> tensor<1x192x2x2x8x8xf32>
    %2 = mhlo.copy %1 : tensor<1x192x2x2x8x8xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x192x2x2x8x8xf32>) -> tensor<1x1x49152xf32>
    %cst = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    %4 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [] : (tensor<f32>) -> tensor<1x1x49152xf32>
    %7 = stablehlo.subtract %3, %6 : tensor<1x1x49152xf32>
    %8 = stablehlo.multiply %7, %7 : tensor<1x1x49152xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x49152xf32>) -> tensor<1x49152xf32>
    return %9 : tensor<1x49152xf32>
  }
  func.func private @fused_computation.159(%arg0: tensor<256x1x192x1x1xf32>) -> tensor<1x1x49152xf32> {
    %0 = mhlo.bitcast %arg0 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<256x1x192x1x1xf32>) -> tensor<2x8x2x8x1x192xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,192,2,2,8,8]{1,0,5,3,4,2}"} : (tensor<2x8x2x8x1x192xf32>) -> tensor<1x192x2x2x8x8xf32>
    %2 = mhlo.copy %1 : tensor<1x192x2x2x8x8xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x192x2x2x8x8xf32>) -> tensor<1x1x49152xf32>
    return %3 : tensor<1x1x49152xf32>
  }
  func.func private @fused_computation.160(%arg0: tensor<1x16x16x192xf32>, %arg1: tensor<2x8x2x8x2xi32>) -> tensor<256x1x192x1x1xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,16,16]{1,3,2,0}"} : (tensor<1x16x16x192xf32>) -> tensor<1x192x16x16xf32>
    %1 = mhlo.copy %0 : tensor<1x192x16x16xf32>
    ...
    %3 = "stablehlo.gather"(%1, %2) <{dimension_numbers = #stablehlo.gather<offset_dims = [1, 2, 3, 4], start_index_map = [2, 3], index_vector_dim = 1>, indices_are_sorted = false, slice_sizes = array<i64: 1, 192, 1, 1>}> : (tensor<1x192x16x16xf32>, tensor<256x2xi32>) -> tensor<256x1x192x1x1xf32>
    return %3 : tensor<256x1x192x1x1xf32>
  }
  ...
  func.func private @fused_computation.162(%arg0: tensor<384xf32>, %arg1: tensor<384xf32>, %arg2: tensor<384xf32>, %arg3: tensor<1x16x16x384xf32>, %arg4: tensor<384xf32>) -> tensor<1x16x16x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x16x16x384xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x16x16x384xf32>
    ...
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x16x16x384xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,16,16]{1,3,2,0}"} : (tensor<1x16x16x384xf32>) -> tensor<1x384x16x16xf32>
    %9 = mhlo.copy %8 : tensor<1x384x16x16xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x384x16x16xf32>
    %11 = stablehlo.negate %9 : tensor<1x384x16x16xf32>
    %12 = stablehlo.exponential %11 : tensor<1x384x16x16xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x384x16x16xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x384x16x16xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x384x16x16xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,16,16,384]{2,1,3,0}"} : (tensor<1x384x16x16xf32>) -> tensor<1x16x16x384xf32>
    %17 = mhlo.copy %16 : tensor<1x16x16x384xf32>
    return %17 : tensor<1x16x16x384xf32>
  }
  func.func private @fused_computation.163(%arg0: tensor<384xf32>) -> tensor<384xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<384xf32>
    %2 = stablehlo.rsqrt %1 : tensor<384xf32>
  ...
  func.func private @fused_computation.164(%arg0: tensor<384x1x3x3xf32>) -> tensor<3x3x1x384xf32> {
  ...
  func.func private @fused_computation.165(%arg0: tensor<384xf32>, %arg1: tensor<384xf32>, %arg2: tensor<384xf32>, %arg3: tensor<1x16x16x384xf32>, %arg4: tensor<384xf32>) -> tensor<1x16x16x384xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x16x16x384xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x16x16x384xf32>
  ...
  func.func private @fused_computation.166(%arg0: tensor<384xf32>) -> tensor<384xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<384xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<384xf32>
    %2 = stablehlo.rsqrt %1 : tensor<384xf32>
  ...
  func.func private @fused_computation.167(%arg0: tensor<384x512x1x1xf32>) -> tensor<1x1x512x384xf32> {
  ...
  func.func private @fused_computation.168(%arg0: tensor<512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<1x16x16x512xf32>, %arg4: tensor<512xf32>) -> tensor<1x16x16x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<512xf32>) -> tensor<1x16x16x512xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x16x16x512xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<512xf32>) -> tensor<1x16x16x512xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x16x16x512xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x16x16x512xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x16x16x512xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<512xf32>) -> tensor<1x16x16x512xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x16x16x512xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,16,16]{1,3,2,0}"} : (tensor<1x16x16x512xf32>) -> tensor<1x512x16x16xf32>
    %9 = mhlo.copy %8 : tensor<1x512x16x16xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x512x16x16xf32>
    %11 = stablehlo.negate %9 : tensor<1x512x16x16xf32>
    %12 = stablehlo.exponential %11 : tensor<1x512x16x16xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x512x16x16xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x512x16x16xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x512x16x16xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,16,16,512]{2,1,3,0}"} : (tensor<1x512x16x16xf32>) -> tensor<1x16x16x512xf32>
    %17 = mhlo.copy %16 : tensor<1x16x16x512xf32>
    return %17 : tensor<1x16x16x512xf32>
  }
  func.func private @fused_computation.169(%arg0: tensor<512xf32>) -> tensor<512xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<512xf32>
    %2 = stablehlo.rsqrt %1 : tensor<512xf32>
  ...
  func.func private @fused_computation.170(%arg0: tensor<512x1x3x3xf32>) -> tensor<3x3x1x512xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[3,3,1,512]{1,0,2,3}"} : (tensor<512x1x3x3xf32>) -> tensor<3x3x1x512xf32>
    %1 = mhlo.copy %0 : tensor<3x3x1x512xf32>
    return %1 : tensor<3x3x1x512xf32>
  }
  func.func private @fused_computation.171(%arg0: tensor<512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>, %arg3: tensor<1x32x32x512xf32>, %arg4: tensor<512xf32>) -> tensor<1x32x32x512xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<512xf32>) -> tensor<1x32x32x512xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x32x32x512xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<512xf32>) -> tensor<1x32x32x512xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x32x32x512xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<512xf32>) -> tensor<1x32x32x512xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x32x32x512xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<512xf32>) -> tensor<1x32x32x512xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x32x32x512xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,32,32]{1,3,2,0}"} : (tensor<1x32x32x512xf32>) -> tensor<1x512x32x32xf32>
    %9 = mhlo.copy %8 : tensor<1x512x32x32xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x512x32x32xf32>
    %11 = stablehlo.negate %9 : tensor<1x512x32x32xf32>
    %12 = stablehlo.exponential %11 : tensor<1x512x32x32xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x512x32x32xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x512x32x32xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x512x32x32xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,32,32,512]{2,1,3,0}"} : (tensor<1x512x32x32xf32>) -> tensor<1x32x32x512xf32>
    %17 = mhlo.copy %16 : tensor<1x32x32x512xf32>
    return %17 : tensor<1x32x32x512xf32>
  }
  func.func private @fused_computation.172(%arg0: tensor<512xf32>) -> tensor<512xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<512xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<512xf32>
    %2 = stablehlo.rsqrt %1 : tensor<512xf32>
  ...
  func.func private @fused_computation.173(%arg0: tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x512xf32>
    return %1 : tensor<1x1x256x512xf32>
  }
  func.func private @fused_computation.174(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x32x32x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x32x32x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x32x32x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x32x32x256xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x32x32x256xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x32x32x256xf32>
    return %7 : tensor<1x32x32x256xf32>
  }
  func.func private @fused_computation.175(%arg0: tensor<256xf32>) -> tensor<256xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.176(%arg0: tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32> {
  ...
  func.func private @fused_computation.177(%arg0: tensor<1x128x32x32xf32>) -> tensor<1x32x32x128xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,32,32,128]{2,1,3,0}"} : (tensor<1x128x32x32xf32>) -> tensor<1x32x32x128xf32>
    %1 = mhlo.copy %0 : tensor<1x32x32x128xf32>
    return %1 : tensor<1x32x32x128xf32>
  }
  func.func private @fused_computation.178(%arg0: tensor<128xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x128x4x256xf32>, %arg4: tensor<1x4x256x128xf32>, %arg5: tensor<128xf32>, %arg6: tensor<128xf32>) -> tensor<1024x1x128x1x1xf32> {
    %0 = stablehlo.broadcast_in_dim %arg6, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %1 = stablehlo.broadcast_in_dim %arg5, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %2 = stablehlo.add %arg4, %1 : tensor<1x4x256x128xf32>
    %3 = stablehlo.transpose %2, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %4 = mhlo.copy %3 : tensor<1x128x4x256xf32>
    %5 = stablehlo.add %4, %arg3 : tensor<1x128x4x256xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %7 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %8 = mhlo.bitcast %7 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %9 = stablehlo.broadcast_in_dim %8, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %10 = stablehlo.subtract %6, %9 : tensor<1x1x131072xf32>
    %11 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %12 = stablehlo.broadcast_in_dim %11, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %13 = stablehlo.multiply %10, %12 : tensor<1x1x131072xf32>
    %14 = mhlo.bitcast %13 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x128x4x256xf32>
    %15 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %16 = stablehlo.multiply %14, %15 : tensor<1x128x4x256xf32>
    %17 = stablehlo.add %0, %16 : tensor<1x128x4x256xf32>
    %18 = mhlo.bitcast %17 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x128x2x2x16x16xf32>
    %19 = stablehlo.transpose %18, dims = [2, 4, 3, 5, 0, 1] {result_layout = dense<[3, 1, 2, 0, 5, 4]> : tensor<6xindex>, xla_shape = "f32[2,16,2,16,1,128]{3,1,2,0,5,4}"} : (tensor<1x128x2x2x16x16xf32>) -> tensor<2x16x2x16x1x128xf32>
    %20 = mhlo.copy %19 : tensor<2x16x2x16x1x128xf32>
    %21 = mhlo.bitcast %20 {result_layout = dense<[2, 0, 4, 3, 1]> : tensor<5xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, xla_shape = "f32[1024,1,128,1,1]{2,0,4,3,1}"} : (tensor<2x16x2x16x1x128xf32>) -> tensor<1024x1x128x1x1xf32>
    %22 = mhlo.copy %21 : tensor<1024x1x128x1x1xf32>
    return %22 : tensor<1024x1x128x1x1xf32>
  }
  func.func private @region_3.3.clone.3.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.179(%arg0: tensor<1x4xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x4xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
    %cst_1 = stablehlo.constant dense<9.99999974E-6> : tensor<1xf32>
    %2 = stablehlo.add %1, %cst_1 : tensor<1xf32>
    %3 = stablehlo.rsqrt %2 : tensor<1xf32>
  ...
  func.func private @fused_computation.180(%arg0: tensor<1xf32>, %arg1: tensor<1x128x4x256xf32>, %arg2: tensor<1x4x256x128xf32>, %arg3: tensor<128xf32>) -> tensor<1x131072xf32> {
    %0 = stablehlo.broadcast_in_dim %arg3, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %1 = stablehlo.add %arg2, %0 : tensor<1x4x256x128xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x128x4x256xf32>
    %4 = stablehlo.add %3, %arg1 : tensor<1x128x4x256xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %6 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %9 = stablehlo.subtract %5, %8 : tensor<1x1x131072xf32>
    %10 = stablehlo.multiply %9, %9 : tensor<1x1x131072xf32>
    %11 = mhlo.bitcast %10 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x131072xf32>
    return %11 : tensor<1x131072xf32>
  }
  func.func private @fused_computation.181(%arg0: tensor<1x128x4x256xf32>, %arg1: tensor<1x4x256x128xf32>, %arg2: tensor<128xf32>) -> tensor<1x1x131072xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x128xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x128x4x256xf32>
    %4 = stablehlo.add %3, %arg0 : tensor<1x128x4x256xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    return %5 : tensor<1x1x131072xf32>
  }
  func.func private @fused_computation.182(%arg0: tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32> {
  ...
  func.func private @fused_computation.183(%arg0: tensor<1x4x256x256xf32>, %arg1: tensor<256xf32>) -> tensor<1x4x256x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<256xf32>) -> tensor<1x4x256x256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x256x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,256]{1,3,2,0}"} : (tensor<1x4x256x256xf32>) -> tensor<1x256x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x256xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %4 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x256x4x256xf32>
    %5 = stablehlo.negate %3 : tensor<1x256x4x256xf32>
    %6 = stablehlo.exponential %5 : tensor<1x256x4x256xf32>
    %7 = stablehlo.add %4, %6 : tensor<1x256x4x256xf32>
    %8 = stablehlo.divide %4, %7 : tensor<1x256x4x256xf32>
    %9 = stablehlo.multiply %3, %8 : tensor<1x256x4x256xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,256,256]{2,1,3,0}"} : (tensor<1x256x4x256xf32>) -> tensor<1x4x256x256xf32>
    %11 = mhlo.copy %10 : tensor<1x4x256x256xf32>
    return %11 : tensor<1x4x256x256xf32>
  }
  func.func private @fused_computation.184(%arg0: tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x256xf32>
    return %1 : tensor<1x1x128x256xf32>
  }
  func.func private @fused_computation.185(%arg0: tensor<128xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x128x4x256xf32>, %arg4: tensor<128xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %4 = stablehlo.broadcast_in_dim %3, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %5 = stablehlo.subtract %1, %4 : tensor<1x1x131072xf32>
    %6 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %8 = stablehlo.multiply %5, %7 : tensor<1x1x131072xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x128x4x256xf32>
    %10 = stablehlo.broadcast_in_dim %arg0, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %11 = stablehlo.multiply %9, %10 : tensor<1x128x4x256xf32>
    %12 = stablehlo.add %0, %11 : tensor<1x128x4x256xf32>
    %13 = stablehlo.transpose %12, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,256,128]{2,1,3,0}"} : (tensor<1x128x4x256xf32>) -> tensor<1x4x256x128xf32>
    %14 = mhlo.copy %13 : tensor<1x4x256x128xf32>
    return %14 : tensor<1x4x256x128xf32>
  }
  func.func private @region_3.3.clone.2.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.186(%arg0: tensor<1x4xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x4xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.187(%arg0: tensor<1xf32>, %arg1: tensor<1x128x4x256xf32>) -> tensor<1x131072xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %3 = stablehlo.broadcast_in_dim %2, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %4 = stablehlo.subtract %0, %3 : tensor<1x1x131072xf32>
    %5 = stablehlo.multiply %4, %4 : tensor<1x1x131072xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x131072xf32>
    return %6 : tensor<1x131072xf32>
  }
  func.func private @fused_computation.188(%arg0: tensor<1x128x4x256xf32>, %arg1: tensor<1x4x256x128xf32>, %arg2: tensor<128xf32>) -> tensor<1x128x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x128xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x128x4x256xf32>
    %4 = stablehlo.add %3, %arg0 : tensor<1x128x4x256xf32>
    return %4 : tensor<1x128x4x256xf32>
  }
  func.func private @fused_computation.189(%arg0: tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32> {
  ...
  func.func private @fused_computation.190(%arg0: tensor<1x128x4xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
    %4 = stablehlo.slice %3 [0:1, 129:257, 0:4, 0:256] : (tensor<1x257x4x256xf32>) -> tensor<1x128x4x256xf32>
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x128x4x256xf32>
    %6 = stablehlo.maximum %4, %5 : tensor<1x128x4x256xf32>
    %7 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x128x4xf32>) -> tensor<128x4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [1, 2] : (tensor<128x4xf32>) -> tensor<1x128x4x256xf32>
    %9 = stablehlo.multiply %6, %8 : tensor<1x128x4x256xf32>
    %10 = stablehlo.transpose %9, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,256,128]{2,1,3,0}"} : (tensor<1x128x4x256xf32>) -> tensor<1x4x256x128xf32>
    %11 = mhlo.copy %10 : tensor<1x4x256x128xf32>
    return %11 : tensor<1x4x256x128xf32>
  }
  func.func private @fused_computation.191(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x128x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
    %4 = stablehlo.slice %3 [0:1, 1:129, 0:4, 0:256] : (tensor<1x257x4x256xf32>) -> tensor<1x128x4x256xf32>
    %5 = mhlo.bitcast %arg0 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x1x4x256xf32>) -> tensor<4x256xf32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [2, 3] : (tensor<4x256xf32>) -> tensor<1x128x4x256xf32>
    %7 = stablehlo.multiply %4, %6 : tensor<1x128x4x256xf32>
    return %7 : tensor<1x128x4x256xf32>
  }
  func.func private @fused_computation.192(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x256xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x256xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x256xf32>
    return %2 : tensor<1x1x4x256xf32>
  }
  func.func private @fused_computation.193(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x1x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:256] : (tensor<1x257x4x256xf32>) -> tensor<1x1x4x256xf32>
    %cst = stablehlo.constant dense<0xFF800000> : tensor<f32>
    %5 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x1x4xf32>
    %6 = stablehlo.maximum %5, %arg0 : tensor<1x1x4xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %8 = stablehlo.broadcast_in_dim %7, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x256xf32>
    %9 = stablehlo.subtract %4, %8 : tensor<1x1x4x256xf32>
    %10 = stablehlo.exponential %9 : tensor<1x1x4x256xf32>
    return %10 : tensor<1x1x4x256xf32>
  }
  func.func private @fused_computation.194(%arg0: tensor<1x4x256x257xf32>, %arg1: tensor<257xf32>) -> tensor<1x1x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
    %4 = stablehlo.slice %3 [0:1, 0:1, 0:4, 0:256] : (tensor<1x257x4x256xf32>) -> tensor<1x1x4x256xf32>
    return %4 : tensor<1x1x4x256xf32>
  }
  func.func private @fused_computation.195(%arg0: tensor<257x128x1x1xf32>) -> tensor<1x1x128x257xf32> {
  ...
  func.func private @fused_computation.196(%arg0: tensor<128xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x128x4x256xf32>, %arg4: tensor<128xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @region_3.3.clone.1.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.197(%arg0: tensor<1x4xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x4xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.198(%arg0: tensor<1xf32>, %arg1: tensor<1x128x4x256xf32>) -> tensor<1x131072xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.199(%arg0: tensor<1x128x4x256xf32>, %arg1: tensor<1x4x256x128xf32>, %arg2: tensor<128xf32>) -> tensor<1x128x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x128xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x128x4x256xf32>
  ...
  func.func private @fused_computation.200(%arg0: tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,128]{1,0,2,3}"} : (tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x128xf32>
    return %1 : tensor<1x1x256x128xf32>
  }
  func.func private @fused_computation.201(%arg0: tensor<1x4x256x256xf32>, %arg1: tensor<256xf32>) -> tensor<1x4x256x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<256xf32>) -> tensor<1x4x256x256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x256x256xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,256]{1,3,2,0}"} : (tensor<1x4x256x256xf32>) -> tensor<1x256x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x256x4x256xf32>
  ...
  func.func private @fused_computation.202(%arg0: tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x256xf32>
    return %1 : tensor<1x1x128x256xf32>
  }
  func.func private @fused_computation.203(%arg0: tensor<128xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1x128x4x256xf32>, %arg4: tensor<128xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %2 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
  ...
  func.func private @region_3.3.clone.clone.2(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.204(%arg0: tensor<1x4xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x4xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.205(%arg0: tensor<1xf32>, %arg1: tensor<1x128x4x256xf32>) -> tensor<1x131072xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %2 = mhlo.bitcast %1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
  ...
  func.func private @fused_computation.206(%arg0: tensor<1x4x256x128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<1024x1x128x1x1xf32>) -> tensor<1x128x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x256x128xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x128x4x256xf32>
    %4 = mhlo.bitcast %arg2 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<1024x1x128x1x1xf32>) -> tensor<2x16x2x16x1x128xf32>
    %5 = stablehlo.transpose %4, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,128,2,2,16,16]{1,0,5,3,4,2}"} : (tensor<2x16x2x16x1x128xf32>) -> tensor<1x128x2x2x16x16xf32>
    %6 = mhlo.copy %5 : tensor<1x128x2x2x16x16xf32>
    %7 = mhlo.bitcast %6 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x128x2x2x16x16xf32>) -> tensor<1x128x4x256xf32>
    %8 = stablehlo.add %3, %7 : tensor<1x128x4x256xf32>
    return %8 : tensor<1x128x4x256xf32>
  }
  func.func private @fused_computation.207(%arg0: tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,128]{1,0,2,3}"} : (tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x128xf32>
    return %1 : tensor<1x1x128x128xf32>
  }
  func.func private @fused_computation.208(%arg0: tensor<1x128x4xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
  ...
  func.func private @fused_computation.209(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x128x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
  ...
  func.func private @fused_computation.210(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<1x1x4xf32>) -> tensor<1x1x4x256xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<0> : tensor<1xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x4xf32>) -> tensor<4xf32>
    %1 = stablehlo.broadcast_in_dim %0, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4x256xf32>
    %2 = stablehlo.divide %arg0, %1 : tensor<1x1x4x256xf32>
    return %2 : tensor<1x1x4x256xf32>
  }
  func.func private @fused_computation.211(%arg0: tensor<1x1x4xf32>, %arg1: tensor<1x4x256x257xf32>, %arg2: tensor<257xf32>) -> tensor<1x1x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg1, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
  ...
  func.func private @fused_computation.212(%arg0: tensor<1x4x256x257xf32>, %arg1: tensor<257xf32>) -> tensor<1x1x4x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<1x4x256x257xf32>
    %2 = stablehlo.transpose %1, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    %3 = mhlo.copy %2 : tensor<1x257x4x256xf32>
  ...
  func.func private @fused_computation.213(%arg0: tensor<257x128x1x1xf32>) -> tensor<1x1x128x257xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,257]{1,0,2,3}"} : (tensor<257x128x1x1xf32>) -> tensor<1x1x128x257xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x257xf32>
    return %1 : tensor<1x1x128x257xf32>
  }
  func.func private @fused_computation.214(%arg0: tensor<128xf32>, %arg1: tensor<1xf32>, %arg2: tensor<1xf32>, %arg3: tensor<1024x1x128x1x1xf32>, %arg4: tensor<128xf32>) -> tensor<1x4x256x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
    %1 = mhlo.bitcast %arg3 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<1024x1x128x1x1xf32>) -> tensor<2x16x2x16x1x128xf32>
    %2 = stablehlo.transpose %1, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,128,2,2,16,16]{1,0,5,3,4,2}"} : (tensor<2x16x2x16x1x128xf32>) -> tensor<1x128x2x2x16x16xf32>
    %3 = mhlo.copy %2 : tensor<1x128x2x2x16x16xf32>
    %4 = mhlo.bitcast %3 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x128x2x2x16x16xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %5 = stablehlo.multiply %arg2, %cst : tensor<1xf32>
    %6 = mhlo.bitcast %5 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %7 = stablehlo.broadcast_in_dim %6, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %8 = stablehlo.subtract %4, %7 : tensor<1x1x131072xf32>
    %9 = mhlo.bitcast %arg1 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %10 = stablehlo.broadcast_in_dim %9, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %11 = stablehlo.multiply %8, %10 : tensor<1x1x131072xf32>
    %12 = mhlo.bitcast %11 {result_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x128x4x256xf32>
    ...
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,4,256,128]{2,1,3,0}"} : (tensor<1x128x4x256xf32>) -> tensor<1x4x256x128xf32>
    %17 = mhlo.copy %16 : tensor<1x4x256x128xf32>
    return %17 : tensor<1x4x256x128xf32>
  }
  func.func private @region_3.3.clone.6(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @fused_computation.215(%arg0: tensor<1x4xf32>) -> tensor<1xf32> {
    %cst = stablehlo.constant dense<0.000000e+00> : tensor<f32>
    %0 = stablehlo.reduce(%arg0 init: %cst) applies stablehlo.add across dimensions = [1] : (tensor<1x4xf32>, tensor<f32>) -> tensor<1xf32>
    %cst_0 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %1 = stablehlo.multiply %0, %cst_0 : tensor<1xf32>
  ...
  func.func private @fused_computation.216(%arg0: tensor<1xf32>, %arg1: tensor<1024x1x128x1x1xf32>) -> tensor<1x131072xf32> {
    %0 = mhlo.bitcast %arg1 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<1024x1x128x1x1xf32>) -> tensor<2x16x2x16x1x128xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,128,2,2,16,16]{1,0,5,3,4,2}"} : (tensor<2x16x2x16x1x128xf32>) -> tensor<1x128x2x2x16x16xf32>
    %2 = mhlo.copy %1 : tensor<1x128x2x2x16x16xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x128x2x2x16x16xf32>) -> tensor<1x1x131072xf32>
    %cst = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    %4 = stablehlo.multiply %arg0, %cst : tensor<1xf32>
    %5 = mhlo.bitcast %4 {result_layout = dense<> : tensor<0xindex>, source_layout = dense<0> : tensor<1xindex>} : (tensor<1xf32>) -> tensor<f32>
    %6 = stablehlo.broadcast_in_dim %5, dims = [] : (tensor<f32>) -> tensor<1x1x131072xf32>
    %7 = stablehlo.subtract %3, %6 : tensor<1x1x131072xf32>
    %8 = stablehlo.multiply %7, %7 : tensor<1x1x131072xf32>
    %9 = mhlo.bitcast %8 {result_layout = dense<[1, 0]> : tensor<2xindex>, source_layout = dense<[2, 1, 0]> : tensor<3xindex>} : (tensor<1x1x131072xf32>) -> tensor<1x131072xf32>
    return %9 : tensor<1x131072xf32>
  }
  func.func private @fused_computation.217(%arg0: tensor<1024x1x128x1x1xf32>) -> tensor<1x1x131072xf32> {
    %0 = mhlo.bitcast %arg0 {result_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>, source_layout = dense<[4, 3, 2, 1, 0]> : tensor<5xindex>} : (tensor<1024x1x128x1x1xf32>) -> tensor<2x16x2x16x1x128xf32>
    %1 = stablehlo.transpose %0, dims = [4, 5, 0, 2, 1, 3] {result_layout = dense<[1, 0, 5, 3, 4, 2]> : tensor<6xindex>, xla_shape = "f32[1,128,2,2,16,16]{1,0,5,3,4,2}"} : (tensor<2x16x2x16x1x128xf32>) -> tensor<1x128x2x2x16x16xf32>
    %2 = mhlo.copy %1 : tensor<1x128x2x2x16x16xf32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[5, 4, 3, 2, 1, 0]> : tensor<6xindex>} : (tensor<1x128x2x2x16x16xf32>) -> tensor<1x1x131072xf32>
    return %3 : tensor<1x1x131072xf32>
  }
  func.func private @fused_computation.218(%arg0: tensor<1x32x32x128xf32>, %arg1: tensor<2x16x2x16x2xi32>) -> tensor<1024x1x128x1x1xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,32,32]{1,3,2,0}"} : (tensor<1x32x32x128xf32>) -> tensor<1x128x32x32xf32>
    %1 = mhlo.copy %0 : tensor<1x128x32x32xf32>
    ...
    %3 = "stablehlo.gather"(%1, %2) <{dimension_numbers = #stablehlo.gather<offset_dims = [1, 2, 3, 4], start_index_map = [2, 3], index_vector_dim = 1>, indices_are_sorted = false, slice_sizes = array<i64: 1, 128, 1, 1>}> : (tensor<1x128x32x32xf32>, tensor<1024x2xi32>) -> tensor<1024x1x128x1x1xf32>
    return %3 : tensor<1024x1x128x1x1xf32>
  }
  ...
  func.func private @fused_computation.220(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x32x32x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x32x32x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x32x32x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x32x32x256xf32>
    ...
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x32x32x256xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,32,32]{1,3,2,0}"} : (tensor<1x32x32x256xf32>) -> tensor<1x256x32x32xf32>
    %9 = mhlo.copy %8 : tensor<1x256x32x32xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x256x32x32xf32>
    %11 = stablehlo.negate %9 : tensor<1x256x32x32xf32>
    %12 = stablehlo.exponential %11 : tensor<1x256x32x32xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x256x32x32xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x256x32x32xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x256x32x32xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,32,32,256]{2,1,3,0}"} : (tensor<1x256x32x32xf32>) -> tensor<1x32x32x256xf32>
    %17 = mhlo.copy %16 : tensor<1x32x32x256xf32>
    return %17 : tensor<1x32x32x256xf32>
  }
  func.func private @fused_computation.221(%arg0: tensor<256xf32>) -> tensor<256xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<256xf32>
    %2 = stablehlo.rsqrt %1 : tensor<256xf32>
  ...
  func.func private @fused_computation.222(%arg0: tensor<256x1x3x3xf32>) -> tensor<3x3x1x256xf32> {
  ...
  func.func private @fused_computation.223(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x32x32x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x32x32x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x32x32x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x32x32x256xf32>
  ...
  func.func private @fused_computation.224(%arg0: tensor<256xf32>) -> tensor<256xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<256xf32>
    %2 = stablehlo.rsqrt %1 : tensor<256xf32>
  ...
  func.func private @fused_computation.225(%arg0: tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x256xf32>
    return %1 : tensor<1x1x256x256xf32>
  }
  func.func private @fused_computation.226(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x32x32x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x32x32x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x32x32x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x32x32x256xf32>
  ...
  func.func private @fused_computation.229(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x64x64x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x64x64x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x64x64x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x256xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x64x64x256xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x64x64x256xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,64,64]{1,3,2,0}"} : (tensor<1x64x64x256xf32>) -> tensor<1x256x64x64xf32>
    %9 = mhlo.copy %8 : tensor<1x256x64x64xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x256x64x64xf32>
    %11 = stablehlo.negate %9 : tensor<1x256x64x64xf32>
    %12 = stablehlo.exponential %11 : tensor<1x256x64x64xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x256x64x64xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x256x64x64xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x256x64x64xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,64,64,256]{2,1,3,0}"} : (tensor<1x256x64x64xf32>) -> tensor<1x64x64x256xf32>
    %17 = mhlo.copy %16 : tensor<1x64x64x256xf32>
    return %17 : tensor<1x64x64x256xf32>
  }
  ...
  func.func private @fused_computation.231(%arg0: tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x256xf32>
    return %1 : tensor<1x1x128x256xf32>
  }
  func.func private @fused_computation.232(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<128xf32>, %arg3: tensor<1x64x64x128xf32>, %arg4: tensor<128xf32>, %arg5: tensor<128xf32>, %arg6: tensor<128xf32>, %arg7: tensor<128xf32>, %arg8: tensor<1x64x64x128xf32>, %arg9: tensor<128xf32>) -> tensor<1x64x64x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg9, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %1 = stablehlo.subtract %arg8, %0 : tensor<1x64x64x128xf32>
    %2 = stablehlo.broadcast_in_dim %arg7, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x128xf32>
    %4 = stablehlo.broadcast_in_dim %arg6, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x64x64x128xf32>
    %6 = stablehlo.broadcast_in_dim %arg5, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x64x64x128xf32>
    %8 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %9 = stablehlo.subtract %arg3, %8 : tensor<1x64x64x128xf32>
    %10 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %11 = stablehlo.multiply %9, %10 : tensor<1x64x64x128xf32>
    %12 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %13 = stablehlo.multiply %11, %12 : tensor<1x64x64x128xf32>
    %14 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %15 = stablehlo.add %13, %14 : tensor<1x64x64x128xf32>
    %16 = stablehlo.add %7, %15 : tensor<1x64x64x128xf32>
    return %16 : tensor<1x64x64x128xf32>
  }
  func.func private @fused_computation.233(%arg0: tensor<128xf32>) -> tensor<128xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.234(%arg0: tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,128]{1,0,2,3}"} : (tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32>
    %1 = mhlo.copy %0 : tensor<1x1x256x128xf32>
    return %1 : tensor<1x1x256x128xf32>
  }
  func.func private @fused_computation.235(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x64x64x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x64x64x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x64x64x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x256xf32>
  ...
  func.func private @fused_computation.237(%arg0: tensor<256x1x3x3xf32>) -> tensor<3x3x1x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[3,3,1,256]{1,0,2,3}"} : (tensor<256x1x3x3xf32>) -> tensor<3x3x1x256xf32>
    %1 = mhlo.copy %0 : tensor<3x3x1x256xf32>
    return %1 : tensor<3x3x1x256xf32>
  }
  func.func private @fused_computation.238(%arg0: tensor<256xf32>, %arg1: tensor<256xf32>, %arg2: tensor<256xf32>, %arg3: tensor<1x64x64x256xf32>, %arg4: tensor<256xf32>) -> tensor<1x64x64x256xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x64x64x256xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<256xf32>) -> tensor<1x64x64x256xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x256xf32>
  ...
  func.func private @fused_computation.239(%arg0: tensor<256xf32>) -> tensor<256xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<256xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<256xf32>
    %2 = stablehlo.rsqrt %1 : tensor<256xf32>
  ...
  func.func private @fused_computation.240(%arg0: tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x256xf32>
    return %1 : tensor<1x1x128x256xf32>
  }
  func.func private @fused_computation.241(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<128xf32>, %arg3: tensor<1x64x64x128xf32>, %arg4: tensor<128xf32>) -> tensor<1x64x64x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x64x64x128xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x128xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x64x64x128xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x64x64x128xf32>
    return %7 : tensor<1x64x64x128xf32>
  }
  func.func private @fused_computation.242(%arg0: tensor<128xf32>) -> tensor<128xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<128xf32>
    %2 = stablehlo.rsqrt %1 : tensor<128xf32>
  ...
  func.func private @fused_computation.243(%arg0: tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32> {
    %0 = stablehlo.transpose %arg0, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,128]{1,0,2,3}"} : (tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32>
    %1 = mhlo.copy %0 : tensor<1x1x128x128xf32>
    return %1 : tensor<1x1x128x128xf32>
  }
  func.func private @fused_computation.244(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<128xf32>, %arg3: tensor<1x64x64x128xf32>, %arg4: tensor<128xf32>) -> tensor<1x64x64x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x64x64x128xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x64x64x128xf32>
    ...
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<128xf32>) -> tensor<1x64x64x128xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x64x64x128xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,64,64]{1,3,2,0}"} : (tensor<1x64x64x128xf32>) -> tensor<1x128x64x64xf32>
    %9 = mhlo.copy %8 : tensor<1x128x64x64xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x128x64x64xf32>
    %11 = stablehlo.negate %9 : tensor<1x128x64x64xf32>
    %12 = stablehlo.exponential %11 : tensor<1x128x64x64xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x128x64x64xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x128x64x64xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x128x64x64xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,64,64,128]{2,1,3,0}"} : (tensor<1x128x64x64xf32>) -> tensor<1x64x64x128xf32>
    %17 = mhlo.copy %16 : tensor<1x64x64x128xf32>
    return %17 : tensor<1x64x64x128xf32>
  }
  func.func private @fused_computation.245(%arg0: tensor<128xf32>) -> tensor<128xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<128xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<128xf32>
    %2 = stablehlo.rsqrt %1 : tensor<128xf32>
  ...
  func.func private @fused_computation.247(%arg0: tensor<128xf32>, %arg1: tensor<128xf32>, %arg2: tensor<128xf32>, %arg3: tensor<1x128x128x128xf32>, %arg4: tensor<128xf32>) -> tensor<1x128x128x128xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<128xf32>) -> tensor<1x128x128x128xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x128x128x128xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<128xf32>) -> tensor<1x128x128x128xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x128x128x128xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<128xf32>) -> tensor<1x128x128x128xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x128x128x128xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<128xf32>) -> tensor<1x128x128x128xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x128x128x128xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,128,128]{1,3,2,0}"} : (tensor<1x128x128x128xf32>) -> tensor<1x128x128x128xf32>
    %9 = mhlo.copy %8 : tensor<1x128x128x128xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x128x128x128xf32>
    %11 = stablehlo.negate %9 : tensor<1x128x128x128xf32>
    %12 = stablehlo.exponential %11 : tensor<1x128x128x128xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x128x128x128xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x128x128x128xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x128x128x128xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,128,128]{2,1,3,0}"} : (tensor<1x128x128x128xf32>) -> tensor<1x128x128x128xf32>
    %17 = mhlo.copy %16 : tensor<1x128x128x128xf32>
    return %17 : tensor<1x128x128x128xf32>
  }
  ...
  func.func private @fused_computation.249(%arg0: tensor<128x64x1x1xf32>) -> tensor<1x1x64x128xf32> {
  ...
  func.func private @fused_computation.250(%arg0: tensor<64xf32>, %arg1: tensor<64xf32>, %arg2: tensor<64xf32>, %arg3: tensor<1x128x128x64xf32>, %arg4: tensor<64xf32>) -> tensor<1x128x128x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x128x128x64xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x128x128x64xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x128x128x64xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x128x128x64xf32>
    return %7 : tensor<1x128x128x64xf32>
  }
  func.func private @fused_computation.251(%arg0: tensor<64xf32>) -> tensor<64xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.252(%arg0: tensor<64x64x1x1xf32>) -> tensor<1x1x64x64xf32> {
  ...
  func.func private @fused_computation.253(%arg0: tensor<64xf32>, %arg1: tensor<64xf32>, %arg2: tensor<64xf32>, %arg3: tensor<1x128x128x64xf32>, %arg4: tensor<64xf32>) -> tensor<1x128x128x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x128x128x64xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x128x128x64xf32>
    ...
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x128x128x64xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,64,128,128]{1,3,2,0}"} : (tensor<1x128x128x64xf32>) -> tensor<1x64x128x128xf32>
    %9 = mhlo.copy %8 : tensor<1x64x128x128xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x64x128x128xf32>
    %11 = stablehlo.negate %9 : tensor<1x64x128x128xf32>
    %12 = stablehlo.exponential %11 : tensor<1x64x128x128xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x64x128x128xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x64x128x128xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x64x128x128xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,128,64]{2,1,3,0}"} : (tensor<1x64x128x128xf32>) -> tensor<1x128x128x64xf32>
    %17 = mhlo.copy %16 : tensor<1x128x128x64xf32>
    return %17 : tensor<1x128x128x64xf32>
  }
  func.func private @fused_computation.254(%arg0: tensor<64xf32>) -> tensor<64xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
    %0 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<64xf32>
    %1 = stablehlo.add %arg0, %0 : tensor<64xf32>
    %2 = stablehlo.rsqrt %1 : tensor<64xf32>
  ...
  func.func private @fused_computation.255(%arg0: tensor<64x1x3x3xf32>) -> tensor<3x3x1x64xf32> {
  ...
  func.func private @fused_computation.256(%arg0: tensor<64xf32>, %arg1: tensor<64xf32>, %arg2: tensor<64xf32>, %arg3: tensor<1x128x128x64xf32>, %arg4: tensor<64xf32>) -> tensor<1x128x128x64xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x128x128x64xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<64xf32>) -> tensor<1x128x128x64xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x128x128x64xf32>
  ...
  func.func private @fused_computation.258(%arg0: tensor<64x32x1x1xf32>) -> tensor<1x1x32x64xf32> {
  ...
  func.func private @fused_computation.259(%arg0: tensor<32xf32>, %arg1: tensor<32xf32>, %arg2: tensor<32xf32>, %arg3: tensor<1x128x128x32xf32>, %arg4: tensor<32xf32>) -> tensor<1x128x128x32xf32> {
    %0 = stablehlo.broadcast_in_dim %arg4, dims = [3] : (tensor<32xf32>) -> tensor<1x128x128x32xf32>
    %1 = stablehlo.subtract %arg3, %0 : tensor<1x128x128x32xf32>
    %2 = stablehlo.broadcast_in_dim %arg2, dims = [3] : (tensor<32xf32>) -> tensor<1x128x128x32xf32>
    %3 = stablehlo.multiply %1, %2 : tensor<1x128x128x32xf32>
    %4 = stablehlo.broadcast_in_dim %arg1, dims = [3] : (tensor<32xf32>) -> tensor<1x128x128x32xf32>
    %5 = stablehlo.multiply %3, %4 : tensor<1x128x128x32xf32>
    %6 = stablehlo.broadcast_in_dim %arg0, dims = [3] : (tensor<32xf32>) -> tensor<1x128x128x32xf32>
    %7 = stablehlo.add %5, %6 : tensor<1x128x128x32xf32>
    %8 = stablehlo.transpose %7, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,32,128,128]{1,3,2,0}"} : (tensor<1x128x128x32xf32>) -> tensor<1x32x128x128xf32>
    %9 = mhlo.copy %8 : tensor<1x32x128x128xf32>
    %cst = stablehlo.constant dense<1.000000e+00> : tensor<f32>
    %10 = stablehlo.broadcast_in_dim %cst, dims = [] : (tensor<f32>) -> tensor<1x32x128x128xf32>
    %11 = stablehlo.negate %9 : tensor<1x32x128x128xf32>
    %12 = stablehlo.exponential %11 : tensor<1x32x128x128xf32>
    %13 = stablehlo.add %10, %12 : tensor<1x32x128x128xf32>
    %14 = stablehlo.divide %10, %13 : tensor<1x32x128x128xf32>
    %15 = stablehlo.multiply %9, %14 : tensor<1x32x128x128xf32>
    %16 = stablehlo.transpose %15, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,128,32]{2,1,3,0}"} : (tensor<1x32x128x128xf32>) -> tensor<1x128x128x32xf32>
    %17 = mhlo.copy %16 : tensor<1x128x128x32xf32>
    return %17 : tensor<1x128x128x32xf32>
  }
  func.func private @fused_computation.260(%arg0: tensor<32xf32>) -> tensor<32xf32> {
    %cst = stablehlo.constant dense<9.99999974E-6> : tensor<f32>
  ...
  func.func private @fused_computation.261(%arg0: tensor<32x3x3x3xf32>) -> tensor<3x3x3x32xf32> {
  ...
  func.func private @fused_computation.262(%arg0: tensor<1x3x256x256xf32>) -> tensor<1x256x256x3xf32> {
    %0 = stablehlo.transpose %arg0, dims = [0, 2, 3, 1] {result_layout = dense<[2, 1, 3, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,256,3]{2,1,3,0}"} : (tensor<1x3x256x256xf32>) -> tensor<1x256x256x3xf32>
    %1 = mhlo.copy %0 : tensor<1x256x256x3xf32>
    return %1 : tensor<1x256x256x3xf32>
  }
  func.func private @fused_computation.263() -> tensor<1024x2xi32> {
  ...
  func.func private @fused_computation.264() -> tensor<2x16x2x16x2xi32> {
    %0 = stablehlo.iota dim = 1 : tensor<2x16xi32>
    %1 = stablehlo.iota dim = 0 : tensor<2x16xi32>
    %2 = stablehlo.add %0, %1 : tensor<2x16xi32>
    %3 = mhlo.bitcast %2 {result_layout = dense<[1, 0, 3, 2]> : tensor<4xindex>, source_layout = dense<[1, 0]> : tensor<2xindex>, xla_shape = "s32[2,16,1,1]{1,0,3,2}"} : (tensor<2x16xi32>) -> tensor<2x16x1x1xi32>
  ...
  func.func private @fused_computation.265() -> tensor<256x2xi32> {
  ...
  func.func private @fused_computation.266() -> tensor<2x8x2x8x2xi32> {
    %0 = stablehlo.iota dim = 0 : tensor<8xi32>
    %c = stablehlo.constant dense<2> : tensor<i32>
    %1 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<8xi32>
    %2 = stablehlo.multiply %0, %1 : tensor<8xi32>
  ...
  func.func private @fused_computation.267() -> tensor<64x2xi32> {
  ...
  func.func private @fused_computation.268() -> tensor<2x4x2x4x2xi32> {
    %0 = stablehlo.iota dim = 0 : tensor<4xi32>
    %c = stablehlo.constant dense<2> : tensor<i32>
    %1 = stablehlo.broadcast_in_dim %c, dims = [] : (tensor<i32>) -> tensor<4xi32>
    %2 = stablehlo.multiply %0, %1 : tensor<4xi32>
  ...
  func.func private @wrapped_broadcast_computation(%arg0: tensor<f32>) -> tensor<1x256x8x8xf32> {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [] : (tensor<f32>) -> tensor<1x256x8x8xf32>
    return %0 : tensor<1x256x8x8xf32>
  }
  func.func private @wrapped_broadcast_computation.1(%arg0: tensor<f32>) -> tensor<1x192x16x16xf32> {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [] : (tensor<f32>) -> tensor<1x192x16x16xf32>
    return %0 : tensor<1x192x16x16xf32>
  }
  func.func private @wrapped_broadcast_computation.2(%arg0: tensor<f32>) -> tensor<1x128x32x32xf32> {
    %0 = stablehlo.broadcast_in_dim %arg0, dims = [] : (tensor<f32>) -> tensor<1x128x32x32xf32>
  ...
  func.func private @wrapped_reduce_window_computation(%arg0: tensor<1x1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x1x128xf32> {
  ...
  func.func private @wrapped_reduce_window_computation.1(%arg0: tensor<1x1x128xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
  ...
  func.func private @wrapped_reduce_computation(%arg0: tensor<1x1x4xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x4xf32>, tensor<f32>) -> tensor<1xf32>
  ...
  func.func private @wrapped_reduce_window_computation.2(%arg0: tensor<1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x4096xf32> {
  ...
  func.func private @wrapped_reduce_window_computation.3(%arg0: tensor<1x4096xf32>, %arg1: tensor<f32>) -> tensor<1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.4(%arg0: tensor<1x128xf32>, %arg1: tensor<f32>) -> tensor<1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.5(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x8xf32> {
  ...
  func.func private @wrapped_reduce_computation.1(%arg0: tensor<1x1x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x8xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.6(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x8xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.2(%arg0: tensor<1x1x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x8xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.7(%arg0: tensor<1x128x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x128x4x8xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
    }) : (tensor<1x128x4x256xf32>, tensor<f32>) -> tensor<1x128x4x8xf32>
    return %0 : tensor<1x128x4x8xf32>
  }
  func.func private @region_7.11.clone(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.3(%arg0: tensor<1x128x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x128x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x128x4x8xf32>, tensor<f32>) -> tensor<1x128x4xf32>
  ...
  func.func private @wrapped_reduce_window_computation.8(%arg0: tensor<1x1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.9(%arg0: tensor<1x1x128xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.4(%arg0: tensor<1x1x4xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x4xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.10(%arg0: tensor<1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x4096xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.11(%arg0: tensor<1x4096xf32>, %arg1: tensor<f32>) -> tensor<1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.12(%arg0: tensor<1x128xf32>, %arg1: tensor<f32>) -> tensor<1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.13(%arg0: tensor<1x1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.14(%arg0: tensor<1x1x128xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.5(%arg0: tensor<1x1x4xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x4xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.15(%arg0: tensor<1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x4096xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.16(%arg0: tensor<1x4096xf32>, %arg1: tensor<f32>) -> tensor<1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.17(%arg0: tensor<1x128xf32>, %arg1: tensor<f32>) -> tensor<1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.18(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x8xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.maximum %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.6(%arg0: tensor<1x1x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x8xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.19(%arg0: tensor<1x1x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x8xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.7(%arg0: tensor<1x1x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x8xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.20(%arg0: tensor<1x128x4x256xf32>, %arg1: tensor<f32>) -> tensor<1x128x4x8xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.8(%arg0: tensor<1x128x4x8xf32>, %arg1: tensor<f32>) -> tensor<1x128x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x128x4x8xf32>, tensor<f32>) -> tensor<1x128x4xf32>
    return %0 : tensor<1x128x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.21(%arg0: tensor<1x1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.22(%arg0: tensor<1x1x128xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.9(%arg0: tensor<1x1x4xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x4xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.23(%arg0: tensor<1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x4096xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.24(%arg0: tensor<1x4096xf32>, %arg1: tensor<f32>) -> tensor<1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.25(%arg0: tensor<1x128xf32>, %arg1: tensor<f32>) -> tensor<1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.26(%arg0: tensor<1x1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.27(%arg0: tensor<1x1x128xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.10(%arg0: tensor<1x1x4xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x4xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.28(%arg0: tensor<1x131072xf32>, %arg1: tensor<f32>) -> tensor<1x4096xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.29(%arg0: tensor<1x4096xf32>, %arg1: tensor<f32>) -> tensor<1x128xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.30(%arg0: tensor<1x128xf32>, %arg1: tensor<f32>) -> tensor<1x4xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_scatter_computation(%arg0: tensor<1x128x32x32xf32>, %arg1: tensor<1024x2xi32>, %arg2: tensor<1024x1x128x1x1xf32>) -> tensor<1x128x32x32xf32> {
  ...
  func.func private @wrapped_reduce_window_computation.31(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
    }) : (tensor<1x1x49152xf32>, tensor<f32>) -> tensor<1x1x48xf32>
    return %0 : tensor<1x1x48xf32>
  }
  func.func private @region_25.33.clone(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_window_computation.32(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
  ...
  func.func private @wrapped_reduce_computation.11(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.33(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
    }) : (tensor<1x49152xf32>, tensor<f32>) -> tensor<1x1536xf32>
    return %0 : tensor<1x1536xf32>
  }
  func.func private @region_27.35.clone.8(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_window_computation.34(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.35(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
  ...
  func.func private @wrapped_reduce_window_computation.36(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.maximum %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.12(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.37(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.13(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.38(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x192x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
    }) : (tensor<1x192x4x64xf32>, tensor<f32>) -> tensor<1x192x4x2xf32>
    return %0 : tensor<1x192x4x2xf32>
  }
  func.func private @region_31.42.clone(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.14(%arg0: tensor<1x192x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x192x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x192x4x2xf32>, tensor<f32>) -> tensor<1x192x4xf32>
    return %0 : tensor<1x192x4xf32>
  }
  func.func private @region_33.44(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_window_computation.39(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.40(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.15(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.41(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.42(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.43(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.44(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.45(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.16(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.46(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.47(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.48(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.49(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.maximum %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.17(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.50(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.18(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.51(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x192x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.19(%arg0: tensor<1x192x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x192x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x192x4x2xf32>, tensor<f32>) -> tensor<1x192x4xf32>
    return %0 : tensor<1x192x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.52(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.53(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.20(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.54(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.55(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.56(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.57(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.58(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.21(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.59(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.60(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.61(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.62(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.maximum %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.22(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.63(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.23(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.64(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x192x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.24(%arg0: tensor<1x192x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x192x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x192x4x2xf32>, tensor<f32>) -> tensor<1x192x4xf32>
    return %0 : tensor<1x192x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.65(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.66(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.25(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.67(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.68(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.69(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.70(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.71(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.26(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.72(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.73(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.74(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.75(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.maximum %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.27(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.maximum across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.76(%arg0: tensor<1x1x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x1x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.28(%arg0: tensor<1x1x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x2xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.77(%arg0: tensor<1x192x4x64xf32>, %arg1: tensor<f32>) -> tensor<1x192x4x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1, 1>, padding = dense<0> : tensor<4x2xi64>, window_dilations = array<i64: 1, 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1, 32>, window_strides = array<i64: 1, 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.29(%arg0: tensor<1x192x4x2xf32>, %arg1: tensor<f32>) -> tensor<1x192x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x192x4x2xf32>, tensor<f32>) -> tensor<1x192x4xf32>
    return %0 : tensor<1x192x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.78(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.79(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.30(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.80(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.81(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.82(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.83(%arg0: tensor<1x1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 1024>, window_strides = array<i64: 1, 1, 1024>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.84(%arg0: tensor<1x1x48xf32>, %arg1: tensor<f32>) -> tensor<1x1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<[[0, 0], [0, 0], [8, 8]]> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.31(%arg0: tensor<1x1x2xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x2xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.85(%arg0: tensor<1x49152xf32>, %arg1: tensor<f32>) -> tensor<1x1536xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.86(%arg0: tensor<1x1536xf32>, %arg1: tensor<f32>) -> tensor<1x48xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.87(%arg0: tensor<1x48xf32>, %arg1: tensor<f32>) -> tensor<1x2xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<[[0, 0], [8, 8]]> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_scatter_computation.1(%arg0: tensor<1x192x16x16xf32>, %arg1: tensor<256x2xi32>, %arg2: tensor<256x1x192x1x1xf32>) -> tensor<1x192x16x16xf32> {
    %0 = "stablehlo.scatter"(%arg0, %arg1, %arg2) <{indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [1, 2, 3, 4], scatter_dims_to_operand_dims = [2, 3], index_vector_dim = 1>, unique_indices = false}> ({
    ^bb0(%arg3: tensor<f32>, %arg4: tensor<f32>):
      %1 = stablehlo.add %arg3, %arg4 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.88(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.89(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
    }) : (tensor<1x1x512xf32>, tensor<f32>) -> tensor<1x1x16xf32>
    return %0 : tensor<1x1x16xf32>
  }
  func.func private @region_67.86.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.32(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.90(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.91(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.33(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x16xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.92(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.93(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_75.97.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.34(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.94(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.95(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.96(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.97(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_78.101.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.35(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.98(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.99(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.36(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x16xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.100(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.101(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_84.108.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.37(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.102(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.103(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.104(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.105(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_87.112.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.38(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.106(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.107(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_computation.39(%arg0: tensor<1x1x4x16xf32>, %arg1: tensor<f32>) -> tensor<1x1x4xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [3] : (tensor<1x1x4x16xf32>, tensor<f32>) -> tensor<1x1x4xf32>
    return %0 : tensor<1x1x4xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.108(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.109(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_93.119.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.40(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.110(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.111(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.112(%arg0: tensor<1x1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.113(%arg0: tensor<1x1x512xf32>, %arg1: tensor<f32>) -> tensor<1x1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1, 1>, padding = dense<0> : tensor<3x2xi64>, window_dilations = array<i64: 1, 1, 1>, window_dimensions = array<i64: 1, 1, 32>, window_strides = array<i64: 1, 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @region_96.123.clone.1(%arg0: tensor<f32>, %arg1: tensor<f32>) -> tensor<f32> {
    %0 = stablehlo.add %arg0, %arg1 : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @wrapped_reduce_computation.41(%arg0: tensor<1x1x16xf32>, %arg1: tensor<f32>) -> tensor<1xf32> {
    %0 = stablehlo.reduce(%arg0 init: %arg1) applies stablehlo.add across dimensions = [1, 2] : (tensor<1x1x16xf32>, tensor<f32>) -> tensor<1xf32>
    return %0 : tensor<1xf32>
  }
  ...
  func.func private @wrapped_reduce_window_computation.114(%arg0: tensor<1x16384xf32>, %arg1: tensor<f32>) -> tensor<1x512xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_reduce_window_computation.115(%arg0: tensor<1x512xf32>, %arg1: tensor<f32>) -> tensor<1x16xf32> {
    %0 = "stablehlo.reduce_window"(%arg0, %arg1) <{base_dilations = array<i64: 1, 1>, padding = dense<0> : tensor<2x2xi64>, window_dilations = array<i64: 1, 1>, window_dimensions = array<i64: 1, 32>, window_strides = array<i64: 1, 32>}> ({
    ^bb0(%arg2: tensor<f32>, %arg3: tensor<f32>):
      %1 = stablehlo.add %arg2, %arg3 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func private @wrapped_scatter_computation.2(%arg0: tensor<1x256x8x8xf32>, %arg1: tensor<64x2xi32>, %arg2: tensor<64x1x256x1x1xf32>) -> tensor<1x256x8x8xf32> {
    %0 = "stablehlo.scatter"(%arg0, %arg1, %arg2) <{indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [1, 2, 3, 4], scatter_dims_to_operand_dims = [2, 3], index_vector_dim = 1>, unique_indices = false}> ({
    ^bb0(%arg3: tensor<f32>, %arg4: tensor<f32>):
      %1 = stablehlo.add %arg3, %arg4 : tensor<f32>
      stablehlo.return %1 : tensor<f32>
  ...
  func.func @main(%arg0: tensor<32x3x3x3xf32>, %arg1: tensor<32xf32>, %arg2: tensor<32xf32>, %arg3: tensor<64x32x1x1xf32>, %arg4: tensor<64xf32>, %arg5: tensor<64xf32>, %arg6: tensor<64x1x3x3xf32>, %arg7: tensor<64xf32>, %arg8: tensor<64xf32>, %arg9: tensor<64x64x1x1xf32>, %arg10: tensor<64xf32>, %arg11: tensor<64xf32>, %arg12: tensor<128x64x1x1xf32>, %arg13: tensor<128xf32>, %arg14: tensor<128xf32>, %arg15: tensor<128x1x3x3xf32>, %arg16: tensor<128xf32>, %arg17: tensor<128xf32>, %arg18: tensor<128x128x1x1xf32>, %arg19: tensor<128xf32>, %arg20: tensor<128xf32>, %arg21: tensor<256x128x1x1xf32>, %arg22: tensor<256xf32>, %arg23: tensor<256xf32>, %arg24: tensor<256x1x3x3xf32>, %arg25: tensor<256xf32>, %arg26: tensor<256xf32>, %arg27: tensor<128x256x1x1xf32>, %arg28: tensor<128xf32>, %arg29: tensor<128xf32>, %arg30: tensor<256x128x1x1xf32>, %arg31: tensor<256xf32>, %arg32: tensor<256xf32>, %arg33: tensor<256x1x3x3xf32>, %arg34: tensor<256xf32>, %arg35: tensor<256xf32>, %arg36: tensor<256x256x1x1xf32>, %arg37: tensor<256xf32>, %arg38: tensor<256xf32>, %arg39: tensor<256x1x3x3xf32>, %arg40: tensor<256xf32>, %arg41: tensor<256xf32>, %arg42: tensor<128x256x1x1xf32>, %arg43: tensor<128xf32>, %arg44: tensor<128xf32>, %arg45: tensor<257x128x1x1xf32>, %arg46: tensor<257xf32>, %arg47: tensor<128x128x1x1xf32>, %arg48: tensor<128xf32>, %arg49: tensor<128xf32>, %arg50: tensor<128xf32>, %arg51: tensor<256x128x1x1xf32>, %arg52: tensor<256xf32>, %arg53: tensor<128x256x1x1xf32>, %arg54: tensor<128xf32>, %arg55: tensor<128xf32>, %arg56: tensor<128xf32>, %arg57: tensor<257x128x1x1xf32>, %arg58: tensor<257xf32>, %arg59: tensor<128x128x1x1xf32>, %arg60: tensor<128xf32>, %arg61: tensor<128xf32>, %arg62: tensor<128xf32>, %arg63: tensor<256x128x1x1xf32>, %arg64: tensor<256xf32>, %arg65: tensor<128x256x1x1xf32>, %arg66: tensor<128xf32>, %arg67: tensor<128xf32>, %arg68: tensor<128xf32>, %arg69: tensor<256x128x1x1xf32>, %arg70: tensor<256xf32>, %arg71: tensor<256xf32>, %arg72: tensor<512x256x1x1xf32>, %arg73: tensor<512xf32>, %arg74: tensor<512xf32>, %arg75: tensor<512x1x3x3xf32>, %arg76: tensor<512xf32>, %arg77: tensor<512xf32>, %arg78: tensor<384x512x1x1xf32>, %arg79: tensor<384xf32>, %arg80: tensor<384xf32>, %arg81: tensor<384x1x3x3xf32>, %arg82: tensor<384xf32>, %arg83: tensor<384xf32>, %arg84: tensor<192x384x1x1xf32>, %arg85: tensor<192xf32>, %arg86: tensor<192xf32>, %arg87: tensor<385x192x1x1xf32>, %arg88: tensor<385xf32>, %arg89: tensor<192x192x1x1xf32>, %arg90: tensor<192xf32>, %arg91: tensor<192xf32>, %arg92: tensor<192xf32>, %arg93: tensor<384x192x1x1xf32>, %arg94: tensor<384xf32>, %arg95: tensor<192x384x1x1xf32>, %arg96: tensor<192xf32>, %arg97: tensor<192xf32>, %arg98: tensor<192xf32>, %arg99: tensor<385x192x1x1xf32>, %arg100: tensor<385xf32>, %arg101: tensor<192x192x1x1xf32>, %arg102: tensor<192xf32>, %arg103: tensor<192xf32>, %arg104: tensor<192xf32>, %arg105: tensor<384x192x1x1xf32>, %arg106: tensor<384xf32>, %arg107: tensor<192x384x1x1xf32>, %arg108: tensor<192xf32>, %arg109: tensor<192xf32>, %arg110: tensor<192xf32>, %arg111: tensor<385x192x1x1xf32>, %arg112: tensor<385xf32>, %arg113: tensor<192x192x1x1xf32>, %arg114: tensor<192xf32>, %arg115: tensor<192xf32>, %arg116: tensor<192xf32>, %arg117: tensor<384x192x1x1xf32>, %arg118: tensor<384xf32>, %arg119: tensor<192x384x1x1xf32>, %arg120: tensor<192xf32>, %arg121: tensor<192xf32>, %arg122: tensor<192xf32>, %arg123: tensor<385x192x1x1xf32>, %arg124: tensor<385xf32>, %arg125: tensor<192x192x1x1xf32>, %arg126: tensor<192xf32>, %arg127: tensor<192xf32>, %arg128: tensor<192xf32>, %arg129: tensor<384x192x1x1xf32>, %arg130: tensor<384xf32>, %arg131: tensor<192x384x1x1xf32>, %arg132: tensor<192xf32>, %arg133: tensor<192xf32>, %arg134: tensor<192xf32>, %arg135: tensor<384x192x1x1xf32>, %arg136: tensor<384xf32>, %arg137: tensor<384xf32>, %arg138: tensor<768x384x1x1xf32>, %arg139: tensor<768xf32>, %arg140: tensor<768xf32>, %arg141: tensor<768x1x3x3xf32>, %arg142: tensor<768xf32>, %arg143: tensor<768xf32>, %arg144: tensor<512x768x1x1xf32>, %arg145: tensor<512xf32>, %arg146: tensor<512xf32>, %arg147: tensor<512x1x3x3xf32>, %arg148: tensor<512xf32>, %arg149: tensor<512xf32>, %arg150: tensor<256x512x1x1xf32>, %arg151: tensor<256xf32>, %arg152: tensor<256xf32>, %arg153: tensor<513x256x1x1xf32>, %arg154: tensor<513xf32>, %arg155: tensor<256x256x1x1xf32>, %arg156: tensor<256xf32>, %arg157: tensor<256xf32>, %arg158: tensor<256xf32>, %arg159: tensor<512x256x1x1xf32>, %arg160: tensor<512xf32>, %arg161: tensor<256x512x1x1xf32>, %arg162: tensor<256xf32>, %arg163: tensor<256xf32>, %arg164: tensor<256xf32>, %arg165: tensor<513x256x1x1xf32>, %arg166: tensor<513xf32>, %arg167: tensor<256x256x1x1xf32>, %arg168: tensor<256xf32>, %arg169: tensor<256xf32>, %arg170: tensor<256xf32>, %arg171: tensor<512x256x1x1xf32>, %arg172: tensor<512xf32>, %arg173: tensor<256x512x1x1xf32>, %arg174: tensor<256xf32>, %arg175: tensor<256xf32>, %arg176: tensor<256xf32>, %arg177: tensor<513x256x1x1xf32>, %arg178: tensor<513xf32>, %arg179: tensor<256x256x1x1xf32>, %arg180: tensor<256xf32>, %arg181: tensor<256xf32>, %arg182: tensor<256xf32>, %arg183: tensor<512x256x1x1xf32>, %arg184: tensor<512xf32>, %arg185: tensor<256x512x1x1xf32>, %arg186: tensor<256xf32>, %arg187: tensor<256xf32>, %arg188: tensor<256xf32>, %arg189: tensor<512x256x1x1xf32>, %arg190: tensor<512xf32>, %arg191: tensor<512xf32>, %arg192: tensor<2x512xf32>, %arg193: tensor<2xf32>, %arg194: tensor<32xf32>, %arg195: tensor<32xf32>, %arg196: tensor<64xf32>, %arg197: tensor<64xf32>, %arg198: tensor<64xf32>, %arg199: tensor<64xf32>, %arg200: tensor<64xf32>, %arg201: tensor<64xf32>, %arg202: tensor<128xf32>, %arg203: tensor<128xf32>, %arg204: tensor<128xf32>, %arg205: tensor<128xf32>, %arg206: tensor<128xf32>, %arg207: tensor<128xf32>, %arg208: tensor<256xf32>, %arg209: tensor<256xf32>, %arg210: tensor<256xf32>, %arg211: tensor<256xf32>, %arg212: tensor<128xf32>, %arg213: tensor<128xf32>, %arg214: tensor<256xf32>, %arg215: tensor<256xf32>, %arg216: tensor<256xf32>, %arg217: tensor<256xf32>, %arg218: tensor<256xf32>, %arg219: tensor<256xf32>, %arg220: tensor<256xf32>, %arg221: tensor<256xf32>, %arg222: tensor<256xf32>, %arg223: tensor<256xf32>, %arg224: tensor<512xf32>, %arg225: tensor<512xf32>, %arg226: tensor<512xf32>, %arg227: tensor<512xf32>, %arg228: tensor<384xf32>, %arg229: tensor<384xf32>, %arg230: tensor<384xf32>, %arg231: tensor<384xf32>, %arg232: tensor<384xf32>, %arg233: tensor<384xf32>, %arg234: tensor<768xf32>, %arg235: tensor<768xf32>, %arg236: tensor<768xf32>, %arg237: tensor<768xf32>, %arg238: tensor<512xf32>, %arg239: tensor<512xf32>, %arg240: tensor<512xf32>, %arg241: tensor<512xf32>, %arg242: tensor<512xf32>, %arg243: tensor<512xf32>, %arg244: tensor<1x3x256x256xf32>) -> tensor<1x2xf32> {
    ...
    %114 = "mhlo.fusion"(%arg43, %113, %108, %104, %arg44) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %116 = "mhlo.fusion"(%arg45) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %120 = "mhlo.fusion"(%119, %arg46) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %123 = "mhlo.fusion"(%122, %119, %arg46) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %127 = "mhlo.fusion"(%126, %119, %arg46) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %130 = "mhlo.fusion"(%129, %119, %arg46) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %132 = "mhlo.fusion"(%arg47) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,128]{1,0,2,3}"} : (tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x128xf32>
      mhlo.return %676 : tensor<1x1x128x128xf32>
    ...
    %136 = "mhlo.fusion"(%135, %arg48, %104) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %146 = "mhlo.fusion"(%arg49, %145, %140, %136, %arg50) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %148 = "mhlo.fusion"(%arg51) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x256xf32>
      mhlo.return %676 : tensor<1x1x128x256xf32>
    ...
    %152 = "mhlo.fusion"(%151, %arg52) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %154 = "mhlo.fusion"(%arg53) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,128]{1,0,2,3}"} : (tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x128xf32>
      mhlo.return %676 : tensor<1x1x256x128xf32>
    ...
    %158 = "mhlo.fusion"(%136, %157, %arg54) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %168 = "mhlo.fusion"(%arg55, %167, %162, %158, %arg56) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x128x4x256xf32>, %arg249: tensor<128xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
      %cst_1 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    ...
    %170 = "mhlo.fusion"(%arg57) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<257x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,257]{1,0,2,3}"} : (tensor<257x128x1x1xf32>) -> tensor<1x1x128x257xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x257xf32>
      mhlo.return %676 : tensor<1x1x128x257xf32>
    ...
    %174 = "mhlo.fusion"(%173, %arg58) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x256x257xf32>, %arg246: tensor<257xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x256x257xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    ...
    %177 = "mhlo.fusion"(%176, %173, %arg58) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x256x257xf32>, %arg247: tensor<257xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x256x257xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    ...
    %181 = "mhlo.fusion"(%180, %173, %arg58) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x256xf32>, %arg246: tensor<1x4x256x257xf32>, %arg247: tensor<257xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x256x257xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    ...
    %184 = "mhlo.fusion"(%183, %173, %arg58) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x128x4xf32>, %arg246: tensor<1x4x256x257xf32>, %arg247: tensor<257xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<257xf32>) -> tensor<1x4x256x257xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x256x257xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,257,4,256]{1,3,2,0}"} : (tensor<1x4x256x257xf32>) -> tensor<1x257x4x256xf32>
    ...
    %186 = "mhlo.fusion"(%arg59) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,128]{1,0,2,3}"} : (tensor<128x128x1x1xf32>) -> tensor<1x1x128x128xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x128xf32>
      mhlo.return %676 : tensor<1x1x128x128xf32>
    ...
    %190 = "mhlo.fusion"(%158, %189, %arg60) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x128x4x256xf32>, %arg246: tensor<1x4x256x128xf32>, %arg247: tensor<128xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x256x128xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    ...
    %200 = "mhlo.fusion"(%arg61, %199, %194, %190, %arg62) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x128x4x256xf32>, %arg249: tensor<128xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<128xf32>) -> tensor<1x128x4x256xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x128x4x256xf32>) -> tensor<1x1x131072xf32>
      %cst_1 = stablehlo.constant dense<7.62939453E-6> : tensor<1xf32>
    ...
    %202 = "mhlo.fusion"(%arg63) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x256xf32>
      mhlo.return %676 : tensor<1x1x128x256xf32>
    ...
    %206 = "mhlo.fusion"(%205, %arg64) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x256x256xf32>, %arg246: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<256xf32>) -> tensor<1x4x256x256xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x256x256xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,256]{1,3,2,0}"} : (tensor<1x4x256x256xf32>) -> tensor<1x256x4x256xf32>
    ...
    %208 = "mhlo.fusion"(%arg65) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<128x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,128]{1,0,2,3}"} : (tensor<128x256x1x1xf32>) -> tensor<1x1x256x128xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x128xf32>
      mhlo.return %676 : tensor<1x1x256x128xf32>
    ...
    %212 = "mhlo.fusion"(%190, %211, %arg66) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x128x4x256xf32>, %arg246: tensor<1x4x256x128xf32>, %arg247: tensor<128xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<128xf32>) -> tensor<1x4x256x128xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x256x128xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,128,4,256]{1,3,2,0}"} : (tensor<1x4x256x128xf32>) -> tensor<1x128x4x256xf32>
    ...
    %216 = "mhlo.fusion"(%215, %190, %211, %arg66) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %221 = "mhlo.fusion"(%arg67, %220, %215, %190, %211, %arg66, %arg68) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %225 = "mhlo.fusion"(%arg69) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x128x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,128,256]{1,0,2,3}"} : (tensor<256x128x1x1xf32>) -> tensor<1x1x128x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x128x256xf32>
      mhlo.return %676 : tensor<1x1x128x256xf32>
    ...
    %229 = "mhlo.fusion"(%arg71, %arg70, %14, %228, %arg222) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256xf32>, %arg246: tensor<256xf32>, %arg247: tensor<256xf32>, %arg248: tensor<1x32x32x256xf32>, %arg249: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
      %676 = stablehlo.subtract %arg248, %675 : tensor<1x32x32x256xf32>
      %677 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<256xf32>) -> tensor<1x32x32x256xf32>
    ...
    %231 = "mhlo.fusion"(%arg72) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %235 = "mhlo.fusion"(%arg74, %arg73, %13, %234, %arg224) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %236 = "mhlo.fusion"(%arg75) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %238 = "mhlo.fusion"(%arg77, %arg76, %12, %237, %arg226) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %240 = "mhlo.fusion"(%arg78) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %244 = "mhlo.fusion"(%arg80, %arg79, %11, %243, %arg228) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %245 = "mhlo.fusion"(%arg81) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %247 = "mhlo.fusion"(%arg83, %arg82, %10, %246, %arg230) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384xf32>, %arg246: tensor<384xf32>, %arg247: tensor<384xf32>, %arg248: tensor<1x16x16x384xf32>, %arg249: tensor<384xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
      %676 = stablehlo.subtract %arg248, %675 : tensor<1x16x16x384xf32>
      %677 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    ...
    %249 = "mhlo.fusion"(%arg84) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %264 = "mhlo.fusion"(%arg85, %263, %258, %254, %arg86) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %266 = "mhlo.fusion"(%arg87) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %270 = "mhlo.fusion"(%269, %arg88) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %273 = "mhlo.fusion"(%272, %269, %arg88) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %277 = "mhlo.fusion"(%276, %269, %arg88) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %280 = "mhlo.fusion"(%279, %269, %arg88) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %282 = "mhlo.fusion"(%arg89) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %286 = "mhlo.fusion"(%285, %arg90, %254) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %296 = "mhlo.fusion"(%arg91, %295, %290, %286, %arg92) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %298 = "mhlo.fusion"(%arg93) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %302 = "mhlo.fusion"(%301, %arg94) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %304 = "mhlo.fusion"(%arg95) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x384x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x384x192xf32>
      mhlo.return %676 : tensor<1x1x384x192xf32>
    ...
    %308 = "mhlo.fusion"(%286, %307, %arg96) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %318 = "mhlo.fusion"(%arg97, %317, %312, %308, %arg98) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %320 = "mhlo.fusion"(%arg99) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<385x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x385xf32>
      mhlo.return %676 : tensor<1x1x192x385xf32>
    ...
    %324 = "mhlo.fusion"(%323, %arg100) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x385xf32>, %arg246: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %327 = "mhlo.fusion"(%326, %323, %arg100) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %331 = "mhlo.fusion"(%330, %323, %arg100) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x64xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %334 = "mhlo.fusion"(%333, %323, %arg100) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %336 = "mhlo.fusion"(%arg101) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x192xf32>
      mhlo.return %676 : tensor<1x1x192x192xf32>
    ...
    %340 = "mhlo.fusion"(%308, %339, %arg102) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %350 = "mhlo.fusion"(%arg103, %349, %344, %340, %arg104) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %352 = "mhlo.fusion"(%arg105) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x384xf32>
      mhlo.return %676 : tensor<1x1x192x384xf32>
    ...
    %356 = "mhlo.fusion"(%355, %arg106) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x384xf32>, %arg246: tensor<384xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x384xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    ...
    %358 = "mhlo.fusion"(%arg107) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x384x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x384x192xf32>
      mhlo.return %676 : tensor<1x1x384x192xf32>
    ...
    %362 = "mhlo.fusion"(%340, %361, %arg108) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %372 = "mhlo.fusion"(%arg109, %371, %366, %362, %arg110) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %374 = "mhlo.fusion"(%arg111) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<385x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x385xf32>
      mhlo.return %676 : tensor<1x1x192x385xf32>
    ...
    %378 = "mhlo.fusion"(%377, %arg112) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x385xf32>, %arg246: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %381 = "mhlo.fusion"(%380, %377, %arg112) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %385 = "mhlo.fusion"(%384, %377, %arg112) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x64xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %388 = "mhlo.fusion"(%387, %377, %arg112) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %390 = "mhlo.fusion"(%arg113) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x192xf32>
      mhlo.return %676 : tensor<1x1x192x192xf32>
    ...
    %394 = "mhlo.fusion"(%362, %393, %arg114) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %404 = "mhlo.fusion"(%arg115, %403, %398, %394, %arg116) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %406 = "mhlo.fusion"(%arg117) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x384xf32>
      mhlo.return %676 : tensor<1x1x192x384xf32>
    ...
    %410 = "mhlo.fusion"(%409, %arg118) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x384xf32>, %arg246: tensor<384xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x384xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    ...
    %412 = "mhlo.fusion"(%arg119) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x384x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x384x192xf32>
      mhlo.return %676 : tensor<1x1x384x192xf32>
    ...
    %416 = "mhlo.fusion"(%394, %415, %arg120) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %426 = "mhlo.fusion"(%arg121, %425, %420, %416, %arg122) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %428 = "mhlo.fusion"(%arg123) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<385x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,385]{1,0,2,3}"} : (tensor<385x192x1x1xf32>) -> tensor<1x1x192x385xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x385xf32>
      mhlo.return %676 : tensor<1x1x192x385xf32>
    ...
    %432 = "mhlo.fusion"(%431, %arg124) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x385xf32>, %arg246: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %435 = "mhlo.fusion"(%434, %431, %arg124) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %439 = "mhlo.fusion"(%438, %431, %arg124) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x64xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %442 = "mhlo.fusion"(%441, %431, %arg124) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4xf32>, %arg246: tensor<1x4x64x385xf32>, %arg247: tensor<385xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<385xf32>) -> tensor<1x4x64x385xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x385xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,385,4,64]{1,3,2,0}"} : (tensor<1x4x64x385xf32>) -> tensor<1x385x4x64xf32>
    ...
    %444 = "mhlo.fusion"(%arg125) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,192]{1,0,2,3}"} : (tensor<192x192x1x1xf32>) -> tensor<1x1x192x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x192xf32>
      mhlo.return %676 : tensor<1x1x192x192xf32>
    ...
    %448 = "mhlo.fusion"(%416, %447, %arg126) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %458 = "mhlo.fusion"(%arg127, %457, %452, %448, %arg128) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x192x4x64xf32>, %arg249: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<192xf32>) -> tensor<1x192x4x64xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x192x4x64xf32>) -> tensor<1x1x49152xf32>
      %cst_1 = stablehlo.constant dense<2.03450527E-5> : tensor<1xf32>
    ...
    %460 = "mhlo.fusion"(%arg129) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x384xf32>
      mhlo.return %676 : tensor<1x1x192x384xf32>
    ...
    %464 = "mhlo.fusion"(%463, %arg130) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x64x384xf32>, %arg246: tensor<384xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<384xf32>) -> tensor<1x4x64x384xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x64x384xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,384,4,64]{1,3,2,0}"} : (tensor<1x4x64x384xf32>) -> tensor<1x384x4x64xf32>
    ...
    %466 = "mhlo.fusion"(%arg131) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<192x384x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,384,192]{1,0,2,3}"} : (tensor<192x384x1x1xf32>) -> tensor<1x1x384x192xf32>
      %676 = mhlo.copy %675 : tensor<1x1x384x192xf32>
      mhlo.return %676 : tensor<1x1x384x192xf32>
    ...
    %470 = "mhlo.fusion"(%448, %469, %arg132) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x192x4x64xf32>, %arg246: tensor<1x4x64x192xf32>, %arg247: tensor<192xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<192xf32>) -> tensor<1x4x64x192xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x64x192xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,192,4,64]{1,3,2,0}"} : (tensor<1x4x64x192xf32>) -> tensor<1x192x4x64xf32>
    ...
    %474 = "mhlo.fusion"(%473, %448, %469, %arg132) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %479 = "mhlo.fusion"(%arg133, %478, %473, %448, %469, %arg132, %arg134) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %483 = "mhlo.fusion"(%arg135) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384x192x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,192,384]{1,0,2,3}"} : (tensor<384x192x1x1xf32>) -> tensor<1x1x192x384xf32>
      %676 = mhlo.copy %675 : tensor<1x1x192x384xf32>
      mhlo.return %676 : tensor<1x1x192x384xf32>
    ...
    %487 = "mhlo.fusion"(%arg137, %arg136, %7, %486, %arg232) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<384xf32>, %arg246: tensor<384xf32>, %arg247: tensor<384xf32>, %arg248: tensor<1x16x16x384xf32>, %arg249: tensor<384xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
      %676 = stablehlo.subtract %arg248, %675 : tensor<1x16x16x384xf32>
      %677 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<384xf32>) -> tensor<1x16x16x384xf32>
    ...
    %489 = "mhlo.fusion"(%arg138) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %493 = "mhlo.fusion"(%arg140, %arg139, %6, %492, %arg234) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %494 = "mhlo.fusion"(%arg141) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %496 = "mhlo.fusion"(%arg143, %arg142, %5, %495, %arg236) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %498 = "mhlo.fusion"(%arg144) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %502 = "mhlo.fusion"(%arg146, %arg145, %4, %501, %arg238) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %503 = "mhlo.fusion"(%arg147) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512x1x3x3xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[3,3,1,512]{1,0,2,3}"} : (tensor<512x1x3x3xf32>) -> tensor<3x3x1x512xf32>
      %676 = mhlo.copy %675 : tensor<3x3x1x512xf32>
      mhlo.return %676 : tensor<3x3x1x512xf32>
    ...
    %505 = "mhlo.fusion"(%arg149, %arg148, %3, %504, %arg240) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512xf32>, %arg246: tensor<512xf32>, %arg247: tensor<512xf32>, %arg248: tensor<1x8x8x512xf32>, %arg249: tensor<512xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
      %676 = stablehlo.subtract %arg248, %675 : tensor<1x8x8x512xf32>
      %677 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    ...
    %507 = "mhlo.fusion"(%arg150) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %521 = "mhlo.fusion"(%arg151, %520, %516, %512, %arg152) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %523 = "mhlo.fusion"(%arg153) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %527 = "mhlo.fusion"(%526, %arg154) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %528 = "mhlo.fusion"(%527, %526, %arg154) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %531 = "mhlo.fusion"(%530, %526, %arg154) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %532 = "mhlo.fusion"(%531, %526, %arg154) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %534 = "mhlo.fusion"(%arg155) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x256xf32>
      mhlo.return %676 : tensor<1x1x256x256xf32>
    ...
    %538 = "mhlo.fusion"(%537, %arg156, %512) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %547 = "mhlo.fusion"(%arg157, %546, %542, %538, %arg158) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %549 = "mhlo.fusion"(%arg159) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x512xf32>
      mhlo.return %676 : tensor<1x1x256x512xf32>
    ...
    %553 = "mhlo.fusion"(%552, %arg160) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %555 = "mhlo.fusion"(%arg161) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x512x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,512,256]{1,0,2,3}"} : (tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x512x256xf32>
      mhlo.return %676 : tensor<1x1x512x256xf32>
    ...
    %559 = "mhlo.fusion"(%538, %558, %arg162) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %568 = "mhlo.fusion"(%arg163, %567, %563, %559, %arg164) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x256x4x16xf32>, %arg249: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
      %cst_1 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    ...
    %570 = "mhlo.fusion"(%arg165) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<513x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,513]{1,0,2,3}"} : (tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x513xf32>
      mhlo.return %676 : tensor<1x1x256x513xf32>
    ...
    %574 = "mhlo.fusion"(%573, %arg166) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x16x513xf32>, %arg246: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %575 = "mhlo.fusion"(%574, %573, %arg166) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %578 = "mhlo.fusion"(%577, %573, %arg166) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x16xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %579 = "mhlo.fusion"(%578, %573, %arg166) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %581 = "mhlo.fusion"(%arg167) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x256xf32>
      mhlo.return %676 : tensor<1x1x256x256xf32>
    ...
    %585 = "mhlo.fusion"(%559, %584, %arg168) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4x16xf32>, %arg246: tensor<1x4x16x256xf32>, %arg247: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x256xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    ...
    %594 = "mhlo.fusion"(%arg169, %593, %589, %585, %arg170) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x256x4x16xf32>, %arg249: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
      %cst_1 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    ...
    %596 = "mhlo.fusion"(%arg171) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x512xf32>
      mhlo.return %676 : tensor<1x1x256x512xf32>
    ...
    %600 = "mhlo.fusion"(%599, %arg172) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x16x512xf32>, %arg246: tensor<512xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<512xf32>) -> tensor<1x4x16x512xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x16x512xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,4,16]{1,3,2,0}"} : (tensor<1x4x16x512xf32>) -> tensor<1x512x4x16xf32>
    ...
    %602 = "mhlo.fusion"(%arg173) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x512x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,512,256]{1,0,2,3}"} : (tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x512x256xf32>
      mhlo.return %676 : tensor<1x1x512x256xf32>
    ...
    %606 = "mhlo.fusion"(%585, %605, %arg174) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4x16xf32>, %arg246: tensor<1x4x16x256xf32>, %arg247: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x256xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    ...
    %615 = "mhlo.fusion"(%arg175, %614, %610, %606, %arg176) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x256x4x16xf32>, %arg249: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
      %cst_1 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    ...
    %617 = "mhlo.fusion"(%arg177) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<513x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,513]{1,0,2,3}"} : (tensor<513x256x1x1xf32>) -> tensor<1x1x256x513xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x513xf32>
      mhlo.return %676 : tensor<1x1x256x513xf32>
    ...
    %621 = "mhlo.fusion"(%620, %arg178) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x16x513xf32>, %arg246: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %622 = "mhlo.fusion"(%621, %620, %arg178) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %625 = "mhlo.fusion"(%624, %620, %arg178) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x1x4x16xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %626 = "mhlo.fusion"(%625, %620, %arg178) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4xf32>, %arg246: tensor<1x4x16x513xf32>, %arg247: tensor<513xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<513xf32>) -> tensor<1x4x16x513xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x513xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,513,4,16]{1,3,2,0}"} : (tensor<1x4x16x513xf32>) -> tensor<1x513x4x16xf32>
    ...
    %628 = "mhlo.fusion"(%arg179) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,256]{1,0,2,3}"} : (tensor<256x256x1x1xf32>) -> tensor<1x1x256x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x256xf32>
      mhlo.return %676 : tensor<1x1x256x256xf32>
    ...
    %632 = "mhlo.fusion"(%606, %631, %arg180) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4x16xf32>, %arg246: tensor<1x4x16x256xf32>, %arg247: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x256xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    ...
    %641 = "mhlo.fusion"(%arg181, %640, %636, %632, %arg182) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256xf32>, %arg246: tensor<1xf32>, %arg247: tensor<1xf32>, %arg248: tensor<1x256x4x16xf32>, %arg249: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [1] : (tensor<256xf32>) -> tensor<1x256x4x16xf32>
      %676 = mhlo.bitcast %arg248 {result_layout = dense<[2, 1, 0]> : tensor<3xindex>, source_layout = dense<[3, 2, 1, 0]> : tensor<4xindex>} : (tensor<1x256x4x16xf32>) -> tensor<1x1x16384xf32>
      %cst_1 = stablehlo.constant dense<6.10351563E-5> : tensor<1xf32>
    ...
    %643 = "mhlo.fusion"(%arg183) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x512xf32>
      mhlo.return %676 : tensor<1x1x256x512xf32>
    ...
    %647 = "mhlo.fusion"(%646, %arg184) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x4x16x512xf32>, %arg246: tensor<512xf32>):
      %675 = stablehlo.broadcast_in_dim %arg246, dims = [3] : (tensor<512xf32>) -> tensor<1x4x16x512xf32>
      %676 = stablehlo.add %arg245, %675 : tensor<1x4x16x512xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,512,4,16]{1,3,2,0}"} : (tensor<1x4x16x512xf32>) -> tensor<1x512x4x16xf32>
    ...
    %649 = "mhlo.fusion"(%arg185) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<256x512x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,512,256]{1,0,2,3}"} : (tensor<256x512x1x1xf32>) -> tensor<1x1x512x256xf32>
      %676 = mhlo.copy %675 : tensor<1x1x512x256xf32>
      mhlo.return %676 : tensor<1x1x512x256xf32>
    ...
    %653 = "mhlo.fusion"(%632, %652, %arg186) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<1x256x4x16xf32>, %arg246: tensor<1x4x16x256xf32>, %arg247: tensor<256xf32>):
      %675 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<256xf32>) -> tensor<1x4x16x256xf32>
      %676 = stablehlo.add %arg246, %675 : tensor<1x4x16x256xf32>
      %677 = stablehlo.transpose %676, dims = [0, 3, 1, 2] {result_layout = dense<[1, 3, 2, 0]> : tensor<4xindex>, xla_shape = "f32[1,256,4,16]{1,3,2,0}"} : (tensor<1x4x16x256xf32>) -> tensor<1x256x4x16xf32>
    ...
    %657 = "mhlo.fusion"(%656, %632, %652, %arg186) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %661 = "mhlo.fusion"(%arg187, %660, %656, %632, %652, %arg186, %arg188) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %665 = "mhlo.fusion"(%arg189) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512x256x1x1xf32>):
      %675 = stablehlo.transpose %arg245, dims = [2, 3, 1, 0] {result_layout = dense<[1, 0, 2, 3]> : tensor<4xindex>, xla_shape = "f32[1,1,256,512]{1,0,2,3}"} : (tensor<512x256x1x1xf32>) -> tensor<1x1x256x512xf32>
      %676 = mhlo.copy %675 : tensor<1x1x256x512xf32>
      mhlo.return %676 : tensor<1x1x256x512xf32>
    ...
    %669 = "mhlo.fusion"(%arg191, %arg190, %0, %668, %arg242) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ^bb0(%arg245: tensor<512xf32>, %arg246: tensor<512xf32>, %arg247: tensor<512xf32>, %arg248: tensor<1x8x8x512xf32>, %arg249: tensor<512xf32>):
      %675 = stablehlo.broadcast_in_dim %arg249, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
      %676 = stablehlo.subtract %arg248, %675 : tensor<1x8x8x512xf32>
      %677 = stablehlo.broadcast_in_dim %arg247, dims = [3] : (tensor<512xf32>) -> tensor<1x8x8x512xf32>
    ...
    %672 = "mhlo.fusion"(%arg192) <{fusion_kind = #mhlo<fusion_kind kLoop>}> ({
    ...
    %673 = "mhlo.fusion"(%arg193, %671, %672) <{fusion_kind = #mhlo<fusion_kind kOutput>}> ({
